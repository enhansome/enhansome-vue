...
## Awesome Vue.js [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@main/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,577 | 🐛 105 | 📅 2026-08-21 [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/vuejs/awesome-vue)
...
* [Release Notes](https://github.com/vuejs/core/releases) ⭐ 54,281 | 🐛 900 | 🌐 TypeScript | 📅 2026-08-31
* [Awesome Vite](https://github.com/vitejs/awesome-vite) ⭐ 17,231 | 🐛 135 | 🌐 JavaScript | 📅 2026-02-04
* [IDE Language Support](https://github.com/vuejs/language-tools?tab=readme-ov-file#vue-language-tools) ⭐ 6,717 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-29
...
* [Vue DevTools](https://github.com/vuejs/devtools) ⭐ 2,897 | 🐛 236 | 🌐 TypeScript | 📅 2026-08-26 - Browser devtools extension for debugging Vue.js applications.
* [vue-i18n](https://github.com/intlify/vue-i18n) ⭐ 2,711 | 🐛 90 | 🌐 TypeScript | 📅 2026-08-28 - Internationalization plugin for Vue.js
...
* [Vue.js TodoMVC](https://github.com/vuejs/vue/tree/dev/examples/todomvc) ⭐ 211,013 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10
...
* [umo editor](https://github.com/umodoc/editor) ⭐ 1,586 | 🐛 1 | 🌐 Vue | 📅 2026-08-27 - Umo Editor is an open-source document editor, based on Vue3 and Tiptap. Visit [Playground](https://demo.umodoc.com/editor?lang=en-US) for a fast experience.
...
* [Skeleton Vue+TypeScript](https://github.com/SierraSoftworks/vue-template) ⭐ 26 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-31 - TypeScript, VueJS, ElementUI, Vue Router, Vuex, Material Icons, BrowserSync, Dockerfile
...
* [slidev](https://github.com/slidevjs/slidev) ⭐ 48,360 | 🐛 224 | 🌐 TypeScript | 📅 2026-08-25 - Presentation Slides for Developers

* [YesPlayMusic](https://github.com/qier222/YesPlayMusic) ⭐ 33,229 | 🐛 653 | 🌐 Vue | 📅 2026-06-14 - High-looking third-party NetEase cloud player, support Windows / macOS / Linux :electron:

* [Wiki.js](https://github.com/Requarks/wiki) ⭐ 28,820 | 🐛 189 | 🌐 Vue | 📅 2026-08-30 - A modern, lightweight and powerful wiki app built on NodeJS, Git and Markdown

* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 28,076 | 🐛 32 | 🌐 PHP | 📅 2026-08-31 - A Free and Opensource Laravel eCommerce framework built for all to build and scale your business.

* [Dashy](https://github.com/lissy93/dashy) ⭐ 26,339 | 🐛 33 | 🌐 Vue | 📅 2026-08-31 - A self-hosted startpage, with an easy to use visual editor, status checking, themes, widgets and tons more

* [Stack Edit](https://github.com/benweet/stackedit/) ⭐ 23,077 | 🐛 732 | 🌐 JavaScript | 📅 2023-07-04 - In-browser Markdown editor
...
* [MyIP](https://github.com/jason5ng32/MyIP) ⭐ 11,777 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-31 - All in one IP Toolbox. Easy to check what's your IPs, IP geolocation, check for DNS leaks, examine WebRTC connections, speed test, ping test, MTR test, check website availability and more.

* [douyin](https://github.com/zyronon/douyin) ⭐ 11,540 | 🐛 24 | 🌐 Vue | 📅 2026-07-21 - Imitate TikTok ，Vue Best practices on Mobile
...
* [Akaunting](https://github.com/akaunting/akaunting) ⭐ 10,100 | 🐛 11 | 🌐 PHP | 📅 2026-08-31 - A free and online accounting software for small businesses and freelancers based on Laravel and VueJS.

* [nativescript-vue](https://github.com/rigor789/nativescript-vue) ⭐ 6,461 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-26 - A Vue.js implementation of the NativeScript renderer.
...
* [GrandNode 2.0](https://github.com/grandnode/grandnode2/) ⭐ 1,324 | 🐛 86 | 🌐 C# | 📅 2026-08-30 - Open Source Cross Platform E-Commerce Solution based on .NET Core 5.0 and MongoDB / Azure CosmosDB / Amazon DocumentDB / VueJS
...
* [LogChimp](https://github.com/logchimp/logchimp) ⭐ 1,122 | 🐛 184 | 🌐 TypeScript | 📅 2026-08-31 - Open-source software to track your customer's feedback to build better products.
...
* [MarkerOn](https://github.com/ifer47/markeron) ⭐ 979 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-31 - Lightweight screen annotation tool built with Tauri v2, Vue 3, and Canvas API for drawing, highlighting, and annotating anywhere on desktop.
...
* [VueFinder File Library](https://github.com/n1crack/vuefinder) ⭐ 601 | 🐛 5 | 🌐 Vue | 📅 2026-08-30 - Web File Manager Library.
...
* [Carpoolear](https://github.com/STS-Rosario/carpoolear) ⭐ 100 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-30 - The open source Vue.js frontend (mobile and cordova app) for the argentinian carpooling application: [Carpoolear](https://carpoolear.com.ar)
...
* [Interface X](https://github.com/empathyco/x) ⭐ 84 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-31 - UI Search\&Discovery components to rapidly build beautiful search experiences
...
* [NocoDB](https://github.com/nocodb/nocodb) ⭐ 64,791 | 🐛 713 | 🌐 TypeScript | 📅 2026-08-31 - An opensource Airtable alternative.
...
* [vuetify](https://github.com/vuetifyjs/vuetify) ⭐ 41,042 | 🐛 394 | 🌐 TypeScript | 📅 2026-08-31 - Material Component Framework for Vue.js 2.
* [Element Plus](https://github.com/element-plus/element-plus) ⭐ 27,725 | 🐛 1,190 | 🌐 TypeScript | 📅 2026-08-31 - A Vue 3 UI Framework.
...
* [Naive UI](https://github.com/TuSimple/naive-ui) ⭐ 18,523 | 🐛 700 | 🌐 TypeScript | 📅 2026-08-27 - A Vue 3 Component Library Fairly Complete, Customizable Themes, Uses TypeScript, Not Too Slow Kinda Interesting
...
* [shadcn-vue](https://github.com/unovue/shadcn-vue) ⭐ 10,523 | 🐛 138 | 🌐 TypeScript | 📅 2026-08-26 - An unofficial, community-led Vue port of [shadcn/ui](https://github.com/shadcn-ui/ui) ⭐ 122,629 | 🐛 2,140 | 🌐 TypeScript | 📅 2026-08-31 (re-usable components built with Reka UI and Tailwind CSS).
* [buefy](https://github.com/rafaelpimpa/buefy) ⭐ 9,521 | 🐛 67 | 🌐 Vue | 📅 2026-08-31 - Components based on Bulma framework.
* [Nuxt UI](https://github.com/nuxt/ui) ⭐ 6,863 | 🐛 261 | 🌐 TypeScript | 📅 2026-08-31 - 125+ accessible and customizable components for Vue and Nuxt, built with Tailwind CSS and Reka UI.
* [Reka UI](https://github.com/unovue/reka-ui) ⭐ 6,758 | 🐛 313 | 🌐 Vue | 📅 2026-08-31 - An open-source library of unstyled, accessible UI primitives for building high-quality design systems and web apps in Vue 3 (formerly Radix Vue).
...
* [Inkline](https://github.com/inkline/inkline/) ⭐ 1,462 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-31 - Inkline is the intuitive UI Components library that gives you a developer-friendly foundation for building Vue.js 3 Design Systems.
* [oruga](https://github.com/oruga-ui/oruga) ⭐ 1,165 | 🐛 18 | 🌐 Vue | 📅 2026-08-31 - UI components for Vue.js without CSS framework dependency.
...
* [flowbite-vue](https://github.com/themesberg/flowbite-vue) ⭐ 955 | 🐛 23 | 🌐 TypeScript | 📅 2026-07-28 - Vue component library based on Tailwind CSS
...
* [Ionic](https://github.com/ionic-team/ionic-framework) ⭐ 52,637 | 🐛 592 | 🌐 TypeScript | 📅 2026-08-28 - Mobile app development framework
* [uni-app](https://github.com/dcloudio/uni-app) ⭐ 41,605 | 🐛 702 | 🌐 JavaScript | 📅 2026-08-31 - A cross-platform framework using Vue.js
...
* [Native script](https://github.com/nativescript-vue/nativescript-vue) ⭐ 6,461 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-26 - Native mobile applications using NativeScript

*Set of components for mobile*

* [vant](https://github.com/youzan/vant) ⭐ 24,383 | 🐛 213 | 🌐 TypeScript | 📅 2026-08-31 - A Vue.js 2.0 Mobile UI From YouZan.
* [NutUI](https://github.com/jdf2e/nutui/) ⭐ 6,509 | 🐛 190 | 🌐 Vue | 📅 2026-04-02 - A Vue.js 2.0 UI Toolkit for Mobile Web
...
* [vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) ⭐ 33,321 | 🐛 67 | 🌐 Vue | 📅 2026-08-31 - A modern vue admin. It is based on Vue3, vite and TypeScript. It's fast！ [Live demo](https://vben.vvbin.cn/)
* [gin-vue-admin](https://github.com/flipped-aurora/gin-vue-admin) ⭐ 24,980 | 🐛 43 | 🌐 Go | 📅 2026-08-29 - 🚀Vite+Vue3+Gin development basic platform. [Live demo](https://demo.gin-vue-admin.com)
* [soybean-admin](https://github.com/soybeanjs/soybean-admin/blob/main/README.en_US.md) ⭐ 14,918 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-13 - A clean, elegant, beautiful and powerful admin template, based on Vue3, Vite5, TypeScript, Pinia, NaiveUI and UnoCSS.
...
* [Nuxt.js](https://github.com/nuxt/nuxt.js) ⭐ 60,807 | 🐛 539 | 🌐 TypeScript | 📅 2026-08-31 - Versatile Vue.js Framework.
...
* [VitePress](https://github.com/vuejs/vitepress) ⭐ 18,262 | 🐛 303 | 🌐 TypeScript | 📅 2026-08-30 - Vite & Vue powered static site generator.
...
* [CabloyJS](https://github.com/zhennann/cabloy) ⭐ 971 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-30 The Ultimate NodeJS Full Stack Business Development Platform, based on KoaJS & EggJS & VueJS & Framework7
...
* [vue-virtual-scroller](https://github.com/Akryum/vue-virtual-scroller) ⭐ 10,791 | 🐛 201 | 🌐 TypeScript | 📅 2026-08-12 - Component to scroll a large amount of elements efficiently (Vue 2.x).
...
* [virtual-scroll](https://github.com/pdanpdan/virtual-scroll) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-31 - High-performance Vue 3 virtual scroll library designed to handle massive lists with ease. Supports vertical, horizontal, and bidirectional (grid) scrolling, dynamic item sizes using ResizeObserver, full support for Right-to-Left (RTL) layouts, build in a11y.
...
* [tanstack-table](https://github.com/tanstack/table) ⭐ 28,396 | 🐛 59 | 🌐 TypeScript | 📅 2026-08-30 - Headless UI for building powerful tables & datagrids.
* [ag-grid-vue](https://github.com/ag-grid/ag-grid) ⭐ 15,571 | 🐛 134 | 🌐 TypeScript | 📅 2026-08-29 - Vue adaptor for ag-Grid.
* [vxe-table](https://github.com/x-extends/vxe-table) ⭐ 8,622 | 🐛 1,345 | 🌐 TypeScript | 📅 2026-08-26 - Vue form/table solution.
...
* [GridSheet](https://github.com/walkframe/gridsheet) ⭐ 195 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - Highly customizable spreadsheet engine with formula support, multi-sheet references, and a Vue3 wrapper built on a Preact core.
...
* [phantom-ui](https://github.com/Aejkatappaja/phantom-ui) ⭐ 793 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31 - Structure-aware skeleton loader web component that measures your real DOM, supports Vue, React, Svelte and plain HTML.
...
* [v-viewer](https://github.com/mirari/v-viewer) ⭐ 2,638 | 🐛 36 | 🌐 Vue | 📅 2026-02-02 - Image viewer component for vue2 and vue3, supports rotation, scale, zoom and so on, based on [viewer.js](https://github.com/fengyuanchen/viewerjs) ⭐ 8,235 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-30
...
* [swiper](https://github.com/nolimits4web/swiper) ⭐ 41,899 | 🐛 236 | 🌐 TypeScript | 📅 2026-08-28 - Official Swiper component for Vue 3. Tree shakable, SSR support, typing, a11y and a lot more
...
* [vue-echarts](https://github.com/ecomfe/vue-echarts) ⭐ 10,742 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-30 - Vue.js component for Apache ECharts™.
* [vue-chartjs](https://github.com/apertureless/vue-chartjs) ⭐ 5,712 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-28 - Vue.js wrapper for Chart.js.
* [vue-data-ui](https://github.com/graphieros/vue-data-ui) ⭐ 2,444 | 🐛 0 | 🌐 Vue | 📅 2026-08-30 - Vue 3 chart library with 60+ components. Official site: <https://vue-data-ui.graphieros.com/>
* [vue-apexcharts](https://github.com/apexcharts/vue-apexcharts) ⭐ 1,343 | 🐛 9 | 🌐 Vue | 📅 2026-08-25 - Vue.js component for [ApexCharts](https://github.com/apexcharts/apexcharts.js) ⭐ 15,146 | 🐛 309 | 🌐 JavaScript | 📅 2026-08-31.
...
* [flowchart-vue](https://github.com/joyceworks/flowchart-vue) ⭐ 361 | 🐛 3 | 🌐 Vue | 📅 2026-08-30 - Flowchart & Flowchart designer component for Vue.js.
...
* [vue-timer-hook](https://github.com/riderx/vue-timer-hook) ⭐ 182 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-31 - Vue 3 Timer module inspired by react-timer-hook
...
* [virtua](https://github.com/inokawa/virtua) ⭐ 3,731 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-31 - A zero-config, fast and small (\~3kB) virtual list component for React and Vue
...
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 2,977 | 🐛 2 | 🌐 Vue | 📅 2026-08-31 - Streaming Markdown renderer for Vue 3, Nuxt, and VitePress AI chat UIs, with support for incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [vue-flow](https://github.com/bcakmakoglu/vue-flow) ⭐ 6,816 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-14 - Interactive, customizeabe, graph & flowchart editor for Vue3
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,974 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-31 - A lightweight Javascript library to easily create highly configurable and interactive particle animations
...
* [v-offline](https://github.com/vinayakkulkarni/v-offline) ⭐ 379 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-30 - Simple, tiny and easy to use detection of offline & online events for your Vue app (less than 390b minified)
...
* [vue-lumino](https://github.com/tupilabs/vue-lumino) ⭐ 99 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-30 - A component to use Vue.js with Jupyter Lumino (PhosphorJS), integrating DOM & VDOM through event listeners and Vue reactivity system.
...
* [form-create](https://github.com/xaboy/form-create) ⭐ 7,095 | 🐛 32 | 🌐 JavaScript | 📅 2026-08-09 - Form builder with dynamic rendering, data collection, validation, and submission capabilities, supporting json data
...
* [v-region](https://github.com/TerryZ/v-region) ⭐ 940 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-31 - A simple region selector, provide Chinese administrative division data.
...
* [v-image](https://github.com/vinayakkulkarni/v-image) ⭐ 41 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-30 :camera: Tiny little component for input type=file (< 1kb, gzipped)
...
* [tiptap](https://github.com/heyscrumpy/tiptap) ⭐ 38,206 | 🐛 831 | 🌐 TypeScript | 📅 2026-08-28 - A renderless and extendable rich-text editor for Vue.js
* [ckeditor5-vue](https://github.com/ckeditor/ckeditor5-vue) ⭐ 387 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-30 - An official CKEditor 5 rich text editor component for Vue.js.
...
* [vue-img-cutter](https://github.com/acccccccb/vue-img-cutter) ⭐ 563 | 🐛 2 | 🌐 Vue | 📅 2026-05-06 - A vue plugin for image cutting tool,it's very convenient to use.
...
* [vue3-form-wizard](https://github.com/parsajiravand/vue3-form-wizard) ⭐ 40 | 🐛 6 | 🌐 Vue | 📅 2026-08-30 - Vue3-form-wizard is a vue based component with no external depenendcies which simplifies tab wizard management.

#### Canvas

* [vue-konva](https://github.com/rafaesc/vue-konva) ⭐ 1,355 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-20 - Vue & Canvas - JavaScript library for drawing complex canvas graphics using Vue.
...
* [vest](https://github.com/ealush/vest) ⭐ 2,665 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-31 - 🦺 Declarative form validation framework inspired by unit testing.
...
* [kitbag/router](https://github.com/kitbagjs/router) ⭐ 253 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-31 - A type safe router for vuejs
...
* [v-github-icon](https://github.com/vinayakkulkarni/v-github-icon) ⭐ 6 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-30 - easily add "that" tiny GitHub icon on the right/left corner of your Vue components/libraries demos' 🤙
...
* [vueuse](https://github.com/vueuse/vueuse) ⭐ 22,339 | 🐛 375 | 🌐 TypeScript | 📅 2026-08-30 - Collection of essential Vue Composition API utils works for Vue 2.x and 3.x.
...
* [tanstack-query](https://github.com/tanstack/query) ⭐ 50,239 | 🐛 136 | 🌐 TypeScript | 📅 2026-08-31 - Powerful asynchronous state management.
...
* [vscode-vue-i18n-ally](https://github.com/antfu/vue-i18n-ally) ⭐ 4,895 | 🐛 474 | 🌐 TypeScript | 📅 2024-12-13 - VSCode extension for better Vue-i18n experiences.
* [intlify/vue-i18n-next](https://github.com/intlify/vue-i18n-next) ⭐ 2,711 | 🐛 90 | 🌐 TypeScript | 📅 2026-08-28 - Vue I18n for Vue 3.
* [vue-intlayer](https://github.com/aymericzip/intlayer) ⭐ 817 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-31 - Intlayer i18n solution for vue 3.
...
* [fluent-vue](https://github.com/Demivan/fluent-vue) ⭐ 278 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-30 - Internationalization plugin for Vue.js (2 and 3). Vue.js integration for Fluent.js - JavaScript implementation of Project Fluent
...
* [v-intl](https://github.com/vinayakkulkarni/v-intl) ⭐ 15 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-30 - Global Intl wrapper for your awesome Vue 3 app 🔉
...
* [pinia](https://github.com/posva/pinia) ⭐ 14,715 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-28 - 🍍 Intuitive, type safe, light and flexible Store for Vue using the composition api with DevTools support.
...
* [vue-apollo](https://github.com/Akryum/vue-apollo) ⭐ 6,034 | 🐛 276 | 🌐 TypeScript | 📅 2026-08-06 - Apollo/GraphQL integration for VueJS.
...
* [vue-types](https://github.com/dwightjack/vue-types) ⭐ 583 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-30 - Vue Prop Types definitions.
...
* [@agentskit/vue](https://github.com/AgentsKit-io/agentskit) ⭐ 25 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-30 - Vue 3 composable and headless chat components for building AI agents, with streaming, tools, memory and RAG.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,468 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-30 - Manage and reuse `vue` components between projects. Easily isolate and share components from any project without changing its source code, organize curated collections and install in different projects.
...
* [vitest](https://github.com/vitest-dev/vitest) ⭐ 17,028 | 🐛 378 | 🌐 TypeScript | 📅 2026-08-31 - Next generation testing framework powered by Vite.
...
* [jest-serializer-vue-tjw](https://github.com/tjw-lint/vue3-snapshot-serializer) ⭐ 16 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-31 - Improved formatting of Jest Snapshots
...
* [Vue Language Tools (Volar)](https://github.com/vuejs/language-tools) ⭐ 6,717 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-29 - ⚡The Fastest Vue Language Support Extension
...
* [Vue.js support for WebStorm](https://github.com/JetBrains/intellij-plugins/tree/master/vuejs) ⭐ 2,268 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-31, IntelliJ IDEA, PhpStorm, PyCharm & RubyMine – official Vue.js support by JetBrains
...
* [Vite](https://github.com/vitejs/vite) ⭐ 82,618 | 🐛 772 | 🌐 TypeScript | 📅 2026-08-31 - Next generation frontend tooling. It's fast!
...
* [Create Vue](https://github.com/vuejs/create-vue) ⭐ 4,396 | 🐛 42 | 🌐 Vue | 📅 2026-08-31
