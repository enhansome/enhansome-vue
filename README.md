...
## Awesome Vue.js [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@main/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 497,890 | 🐛 104 | 📅 2026-08-18 [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/vuejs/awesome-vue)
...
* [Release Notes](https://github.com/vuejs/core/releases) ⭐ 54,218 | 🐛 908 | 🌐 TypeScript | 📅 2026-08-20
* [Awesome Vite](https://github.com/vitejs/awesome-vite) ⭐ 17,222 | 🐛 133 | 🌐 JavaScript | 📅 2026-02-04
* [IDE Language Support](https://github.com/vuejs/language-tools?tab=readme-ov-file#vue-language-tools) ⭐ 6,711 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-19
...
* [unplugin-icons](https://github.com/unplugin/unplugin-icons) ⭐ 4,931 | 🐛 86 | 🌐 TypeScript | 📅 2026-01-14 - On-demand icon loader supporting all known popular icon sets
* [Vue DevTools](https://github.com/vuejs/devtools) ⭐ 2,888 | 🐛 233 | 🌐 TypeScript | 📅 2026-08-18 - Browser devtools extension for debugging Vue.js applications.
* [vue-i18n](https://github.com/intlify/vue-i18n) ⭐ 2,706 | 🐛 92 | 🌐 TypeScript | 📅 2026-08-17 - Internationalization plugin for Vue.js
...
* [Vue.js TodoMVC](https://github.com/vuejs/vue/tree/dev/examples/todomvc) ⭐ 210,236 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10

### Tutorials

* [Help you learn more efficiently vue3 source code - mini-vue](https://github.com/cuixiaorui/mini-vue) ⭐ 10,549 | 🐛 27 | 🌐 TypeScript | 📅 2024-03-25 by cuixiaorui
...
* [umo editor](https://github.com/umodoc/editor) ⭐ 1,573 | 🐛 1 | 🌐 Vue | 📅 2026-08-20 - Umo Editor is an open-source document editor, based on Vue3 and Tiptap. Visit [Playground](https://demo.umodoc.com/editor?lang=en-US) for a fast experience.
* [X-Flowchart-Vue](https://github.com/OXOYO/X-Flowchart-Vue) ⭐ 1,526 | 🐛 4 | 🌐 JavaScript | 📅 2025-05-14 - A flowchart editor with SVG and Vue
* [Vitesse-lite Starter](https://github.com/antfu/vitesse-lite) ⭐ 1,251 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-06 ⛺️ Lightweight version of Vitesse (Vue 3 Starter)
...
* [vue-vuex-todomvc](https://github.com/bahmutov/vue-vuex-todomvc) ⭐ 48 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-18 - Example TodoMVC Vue.js app with Vuex store and server backend via REST and full set of E2E tests using [Cypress.io](https://www.cypress.io/) test runner.
...
* [vue-stack-cesium](https://github.com/meschg/vue-stack-cesium) ⭐ 22 | 🐛 1 | 🌐 Vue | 📅 2026-08-20 - A minimal sample configuration project with [CesiumJS](https://cesium.com/cesiumjs/) and all the awesome vue features. The project contains many examples how to combine and use certain packages to get started.
...
* [slidev](https://github.com/slidevjs/slidev) ⭐ 48,158 | 🐛 210 | 🌐 TypeScript | 📅 2026-08-19 - Presentation Slides for Developers

* [YesPlayMusic](https://github.com/qier222/YesPlayMusic) ⭐ 33,172 | 🐛 652 | 🌐 Vue | 📅 2026-06-14 - High-looking third-party NetEase cloud player, support Windows / macOS / Linux :electron:

* [Wiki.js](https://github.com/Requarks/wiki) ⭐ 28,779 | 🐛 189 | 🌐 Vue | 📅 2026-08-18 - A modern, lightweight and powerful wiki app built on NodeJS, Git and Markdown

* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 27,983 | 🐛 32 | 🌐 PHP | 📅 2026-08-19 - A Free and Opensource Laravel eCommerce framework built for all to build and scale your business.

* [Dashy](https://github.com/lissy93/dashy) ⭐ 26,241 | 🐛 34 | 🌐 Vue | 📅 2026-08-16 - A self-hosted startpage, with an easy to use visual editor, status checking, themes, widgets and tons more

* [Stack Edit](https://github.com/benweet/stackedit/) ⭐ 23,067 | 🐛 732 | 🌐 JavaScript | 📅 2023-07-04 - In-browser Markdown editor

* [Daily](https://github.com/dailynowco/daily) ⭐ 20,020 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-12 - Curated dev news delivered to your new tab 👩🏽‍💻

* [Koel](https://github.com/phanan/koel) ⭐ 17,222 | 🐛 14 | 🌐 PHP | 📅 2026-08-19 - A personal music streaming server that works.

* [MyIP](https://github.com/jason5ng32/MyIP) ⭐ 11,679 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-20 - All in one IP Toolbox. Easy to check what's your IPs, IP geolocation, check for DNS leaks, examine WebRTC connections, speed test, ping test, MTR test, check website availability and more.

* [douyin](https://github.com/zyronon/douyin) ⭐ 11,530 | 🐛 24 | 🌐 Vue | 📅 2026-07-21 - Imitate TikTok ，Vue Best practices on Mobile

* [vue-storefront](https://github.com/DivanteLtd/vue-storefront) ⭐ 10,943 | 🐛 52 | 📅 2026-06-09 - Vue.js Storefront - PWA for eCommerce. 100% offline, platform agnostic, headless, Magento2 supported.

* [Akaunting](https://github.com/akaunting/akaunting) ⭐ 10,073 | 🐛 10 | 🌐 PHP | 📅 2026-08-18 - A free and online accounting software for small businesses and freelancers based on Laravel and VueJS.

* [nativescript-vue](https://github.com/rigor789/nativescript-vue) ⭐ 6,461 | 🐛 37 | 🌐 TypeScript | 📅 2025-10-17 - A Vue.js implementation of the NativeScript renderer.
...
* [MQTTX](https://github.com/emqx/MQTTX) ⭐ 5,026 | 🐛 109 | 🌐 TypeScript | 📅 2026-08-17 - Cross-platform MQTT 5.0 desktop client built with Vue.js, Typescript and Electron.

* [astralapp](https://github.com/astralapp/astral) ⭐ 3,567 | 🐛 40 | 🌐 PHP | 📅 2026-07-11 - Organize Your GitHub Stars With Ease.

* [CoreUI Vue Admin Template](https://github.com/coreui/coreui-free-vue-admin-template) ⭐ 3,407 | 🐛 0 | 🌐 Vue | 📅 2026-08-14 - Open Source Admin Template powered by Vue.js

* [PJ Blog](https://github.com/jcc/blog) ⭐ 2,855 | 🐛 38 | 🌐 PHP | 📅 2023-06-08 - Open source blog built with Laravel and Vue.js.

* [Antares SQL](https://github.com/Fabio286/antares) ⭐ 2,648 | 🐛 149 | 🌐 Vue | 📅 2025-10-14 - Cross platform SQL client made to be simple and complete.
...
* [GrandNode 2.0](https://github.com/grandnode/grandnode2/) ⭐ 1,326 | 🐛 86 | 🌐 C# | 📅 2026-08-19 - Open Source Cross Platform E-Commerce Solution based on .NET Core 5.0 and MongoDB / Azure CosmosDB / Amazon DocumentDB / VueJS
...
* [LogChimp](https://github.com/logchimp/logchimp) ⭐ 1,119 | 🐛 187 | 🌐 TypeScript | 📅 2026-08-19 - Open-source software to track your customer's feedback to build better products.
...
* [MarkerOn](https://github.com/ifer47/markeron) ⭐ 912 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-20 - Lightweight screen annotation tool built with Tauri v2, Vue 3, and Canvas API for drawing, highlighting, and annotating anywhere on desktop.
...
* [FavBox](https://github.com/dd3v/favbox) ⭐ 764 | 🐛 11 | 🌐 Vue | 📅 2026-08-20 - Local-first browser extension for smarter bookmark management with tags, search, duplicate and broken link detection. Built with Vue 3, Vite and IndexedDB.

* [VueFinder File Library](https://github.com/n1crack/vuefinder) ⭐ 599 | 🐛 5 | 🌐 Vue | 📅 2026-08-18 - Web File Manager Library.
...
* [Socialhome](https://github.com/jaywink/socialhome) ⭐ 387 | 🐛 127 | 🌐 Python | 📅 2026-08-16 - A federated rich profile builder with social networking features
...
* [Carpoolear](https://github.com/STS-Rosario/carpoolear) ⭐ 100 | 🐛 38 | 🌐 JavaScript | 📅 2026-08-18 - The open source Vue.js frontend (mobile and cordova app) for the argentinian carpooling application: [Carpoolear](https://carpoolear.com.ar)
...
* [Interface X](https://github.com/empathyco/x) ⭐ 85 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-18 - UI Search\&Discovery components to rapidly build beautiful search experiences

* [CodeceptJS UI](https://github.com/codecept-js/ui) ⭐ 84 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-20 - Cypress-liked UI for ✔️ CodeceptJS end 2 end tests ✔️.
...
* [peregrine-cms](https://github.com/headwirecom/peregrine-cms) ⭐ 54 | 🐛 90 | 🌐 JavaScript | 📅 2026-08-19 - A Vue.js and Apache Sling based head-optional CMS
...
* [NocoDB](https://github.com/nocodb/nocodb) ⭐ 64,594 | 🐛 699 | 🌐 TypeScript | 📅 2026-08-20 - An opensource Airtable alternative.
* [NxShell](https://github.com/nxshell/nxshell) ⭐ 1,255 | 🐛 147 | 🌐 JavaScript | 📅 2023-12-24 - An easy to use new terminal for SSH, which based on Electron and VueJS.
...
* [vuetify](https://github.com/vuetifyjs/vuetify) ⭐ 41,031 | 🐛 386 | 🌐 TypeScript | 📅 2026-08-19 - Material Component Framework for Vue.js 2.
* [Element Plus](https://github.com/element-plus/element-plus) ⭐ 27,682 | 🐛 1,202 | 🌐 TypeScript | 📅 2026-08-20 - A Vue 3 UI Framework.
* [quasar-framework](https://github.com/quasarframework/quasar) ⭐ 27,205 | 🐛 322 | 🌐 JavaScript | 📅 2026-08-19 - Quasar Framework. Build responsive websites, hybrid mobile Apps and Electron apps using same code, with Vue.js 3.
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,618 | 🐛 128 | 🌐 Vue | 📅 2026-08-15 - An enterprise-class UI components based on Ant Design and Vue 3.2.0
* [Naive UI](https://github.com/TuSimple/naive-ui) ⭐ 18,497 | 🐛 688 | 🌐 TypeScript | 📅 2026-08-19 - A Vue 3 Component Library Fairly Complete, Customizable Themes, Uses TypeScript, Not Too Slow Kinda Interesting
* [BootstrapVue](https://github.com/bootstrap-vue/bootstrap-vue) ⭐ 14,425 | 🐛 202 | 🌐 JavaScript | 📅 2026-04-02 - Bootstrap v4 components and grid system for Vue.js.
* [shadcn-vue](https://github.com/unovue/shadcn-vue) ⭐ 10,471 | 🐛 137 | 🌐 TypeScript | 📅 2026-08-17 - An unofficial, community-led Vue port of [shadcn/ui](https://github.com/shadcn-ui/ui) ⭐ 121,678 | 🐛 2,300 | 🌐 TypeScript | 📅 2026-08-19 (re-usable components built with Reka UI and Tailwind CSS).
* [buefy](https://github.com/rafaelpimpa/buefy) ⭐ 9,519 | 🐛 71 | 🌐 Vue | 📅 2026-08-17 - Components based on Bulma framework.
* [Nuxt UI](https://github.com/nuxt/ui) ⭐ 6,843 | 🐛 248 | 🌐 TypeScript | 📅 2026-08-19 - 125+ accessible and customizable components for Vue and Nuxt, built with Tailwind CSS and Reka UI.
* [Reka UI](https://github.com/unovue/reka-ui) ⭐ 6,733 | 🐛 311 | 🌐 Vue | 📅 2026-08-18 - An open-source library of unstyled, accessible UI primitives for building high-quality design systems and web apps in Vue 3 (formerly Radix Vue).
...
* [oruga](https://github.com/oruga-ui/oruga) ⭐ 1,165 | 🐛 19 | 🌐 Vue | 📅 2026-08-19 - UI components for Vue.js without CSS framework dependency.
...
* [@Carbon/vue](https://github.com/carbon-design-system/carbon-components-vue) ⭐ 650 | 🐛 30 | 🌐 JavaScript | 📅 2026-08-20 - Carbon Design System components from the @carbon team.
* [CoreUI for Vue.js](https://github.com/coreui/coreui-vue) ⭐ 642 | 🐛 3 | 🌐 MDX | 📅 2026-08-18 - CoreUI for Vue.js is a UI Component Library that offers a bunch of cross-browser, responsive, and lightweight Vue.js UI components.
...
* [Ionic](https://github.com/ionic-team/ionic-framework) ⭐ 52,621 | 🐛 593 | 🌐 TypeScript | 📅 2026-08-20 - Mobile app development framework
* [uni-app](https://github.com/dcloudio/uni-app) ⭐ 41,598 | 🐛 697 | 🌐 JavaScript | 📅 2026-08-20 - A cross-platform framework using Vue.js
* [Framework7-Vue](https://github.com/framework7io/framework7) ⭐ 18,744 | 🐛 246 | 🌐 JavaScript | 📅 2026-07-28 - Build full-featured iOS & Android apps using Framework7 & Vue.
...
* [Native script](https://github.com/nativescript-vue/nativescript-vue) ⭐ 6,461 | 🐛 37 | 🌐 TypeScript | 📅 2025-10-17 - Native mobile applications using NativeScript

*Set of components for mobile*

* [vant](https://github.com/youzan/vant) ⭐ 24,363 | 🐛 219 | 🌐 TypeScript | 📅 2026-08-19 - A Vue.js 2.0 Mobile UI From YouZan.
...
* [uiv](https://github.com/uiv-lib/uiv) ⭐ 938 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-19 - Bootstrap3 components implemented by Vue2.
...
* [vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) ⭐ 33,171 | 🐛 75 | 🌐 Vue | 📅 2026-08-19 - A modern vue admin. It is based on Vue3, vite and TypeScript. It's fast！ [Live demo](https://vben.vvbin.cn/)
* [gin-vue-admin](https://github.com/flipped-aurora/gin-vue-admin) ⭐ 24,951 | 🐛 40 | 🌐 Go | 📅 2026-08-15 - 🚀Vite+Vue3+Gin development basic platform. [Live demo](https://demo.gin-vue-admin.com)
* [soybean-admin](https://github.com/soybeanjs/soybean-admin/blob/main/README.en_US.md) ⭐ 14,847 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-13 - A clean, elegant, beautiful and powerful admin template, based on Vue3, Vite5, TypeScript, Pinia, NaiveUI and UnoCSS.
...
* [dashboard](https://github.com/zce/dashboard) ⭐ 558 | 🐛 14 | 🌐 Vue | 📅 2026-08-20 - A dashboard scaffolding based on vue.js created by vuejs/vue-cli 4.x. [Online Demo](https://dashboard.zce.me)
...
* [Nuxt.js](https://github.com/nuxt/nuxt.js) ⭐ 60,764 | 🐛 537 | 🌐 TypeScript | 📅 2026-08-19 - Versatile Vue.js Framework.
...
* [VitePress](https://github.com/vuejs/vitepress) ⭐ 18,205 | 🐛 324 | 🌐 TypeScript | 📅 2026-08-20 - Vite & Vue powered static site generator.
...
* [vue-virtual-scroll-list](https://github.com/tangbc/vue-virtual-scroll-list) ⭐ 4,507 | 🐛 79 | 🌐 JavaScript | 📅 2024-05-08 - A vue (2.x) component support big data by using virtual scroll list.
* [splitpanes](https://github.com/antoniandre/splitpanes) ⭐ 2,249 | 🐛 25 | 🌐 Vue | 📅 2026-08-12 - A Vue JS reliable, simple and touch-ready panes splitter / resizer.
...
* [tanstack-table](https://github.com/tanstack/table) ⭐ 28,354 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-18 - Headless UI for building powerful tables & datagrids.
* [ag-grid-vue](https://github.com/ag-grid/ag-grid) ⭐ 15,550 | 🐛 134 | 🌐 TypeScript | 📅 2026-08-20 - Vue adaptor for ag-Grid.
* [vxe-table](https://github.com/x-extends/vxe-table) ⭐ 8,614 | 🐛 1,343 | 🌐 TypeScript | 📅 2026-08-19 - Vue form/table solution.
* [vue-cheetah-grid](https://github.com/future-architect/cheetah-grid) ⭐ 1,531 | 🐛 38 | 🌐 JavaScript | 📅 2026-08-20 - A high-performance grid engine that work on a canvas for Vue.js.
...
* [vue-crud-x](https://github.com/ais-one/cookbook) ⭐ 461 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-19 - Extensible crud component using Vuetify layout, other than the usual page, sort, filter, it is able to do nested CRUD, custom forms, filters, operations.
* [jz-gantt](https://github.com/jeremyjone/jz-gantt) ⭐ 348 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-19 - A high-performance Vue gantt component, which includes highly customizable table columns, dynamic update data, freely drag the progress bar, switch header, etc.
...
* [vue-datagrid](https://github.com/revolist/vue-datagrid) ⭐ 211 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-18 - Vue grid wrapper for powerful webcomponent revo-grid with excel like rich edit and behavior.
* [GridSheet](https://github.com/walkframe/gridsheet) ⭐ 194 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-18 - Highly customizable spreadsheet engine with formula support, multi-sheet references, and a Vue3 wrapper built on a Preact core.
...
* [v-tooltip](https://github.com/Akryum/vue-tooltip) ⭐ 3,463 | 🐛 173 | 🌐 TypeScript | 📅 2026-07-31 - Easy tooltips with Vue 2.x.
...
* [v-viewer](https://github.com/mirari/v-viewer) ⭐ 2,639 | 🐛 36 | 🌐 Vue | 📅 2026-02-02 - Image viewer component for vue2 and vue3, supports rotation, scale, zoom and so on, based on [viewer.js](https://github.com/fengyuanchen/viewerjs) ⭐ 8,232 | 🐛 40 | 🌐 JavaScript | 📅 2026-07-18
...
* [swiper](https://github.com/nolimits4web/swiper) ⭐ 41,884 | 🐛 254 | 🌐 TypeScript | 📅 2026-08-06 - Official Swiper component for Vue 3. Tree shakable, SSR support, typing, a11y and a lot more
* [@egjs/vue-flicking](https://github.com/naver/egjs-flicking/blob/master/packages/vue3-flicking/README.md) ⭐ 2,923 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-11 - It's reliable, flexible and extendable carousel for Vue.js 2 & 3.
...
* [vue-echarts](https://github.com/ecomfe/vue-echarts) ⭐ 10,735 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-20 - Vue.js component for Apache ECharts™.
* [vue-chartjs](https://github.com/apertureless/vue-chartjs) ⭐ 5,713 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-18 - Vue.js wrapper for Chart.js.
* [vue-data-ui](https://github.com/graphieros/vue-data-ui) ⭐ 2,440 | 🐛 0 | 🌐 Vue | 📅 2026-08-20 - Vue 3 chart library with 60+ components. Official site: <https://vue-data-ui.graphieros.com/>
* [vue-apexcharts](https://github.com/apexcharts/vue-apexcharts) ⭐ 1,344 | 🐛 9 | 🌐 Vue | 📅 2026-08-11 - Vue.js component for [ApexCharts](https://github.com/apexcharts/apexcharts.js) ⭐ 15,128 | 🐛 328 | 🌐 JavaScript | 📅 2026-08-18.
...
* [schedule-x](https://github.com/schedule-x/schedule-x) ⭐ 2,534 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - A material design event calendar. Customizable, light- and dark modes & multilingual.
...
* [qalendar](https://github.com/tomosterlund/qalendar) ⭐ 292 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-20 - An event calendar and datepicker for Vue 3
...
* [@maxel01/vue-leaflet](https://github.com/maxel01/vue-leaflet) ⭐ 53 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-19 - Vue 3 components for Leaflet (2.x) maps.
* [mapmetrics-gl](https://github.com/MapMetrics/mapmetrics-gl) ⭐ 2 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-19 - Mapbox GL JS-compatible mapping library with built-in tiles, geocoding, routing, and search.
...
* [virtua](https://github.com/inokawa/virtua) ⭐ 3,718 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-19 - A zero-config, fast and small (\~3kB) virtual list component for React and Vue
...
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 2,903 | 🐛 0 | 🌐 Vue | 📅 2026-08-20 - Streaming Markdown renderer for Vue 3, Nuxt, and VitePress AI chat UIs, with support for incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [@tato30/vue-pdf](https://github.com/TaTo30/VuePDF) ⭐ 689 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-19 - A PDF viewer for Vue 3. [Demo](https://tato30.github.io/VuePDF/)
...
* [vue-flow](https://github.com/bcakmakoglu/vue-flow) ⭐ 6,788 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-14 - Interactive, customizeabe, graph & flowchart editor for Vue3
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,956 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - A lightweight Javascript library to easily create highly configurable and interactive particle animations
* [vue-advanced-chat](https://github.com/antoine92190/vue-advanced-chat) ⭐ 2,079 | 🐛 92 | 🌐 TypeScript | 📅 2026-08-10 - Feature-rich and fully customizable chat rooms component. Support files, images, videos, audio, emojis, customised actions, etc.
...
* [vue-word-highlighter](https://github.com/kawamataryo/vue-word-highlighter) ⭐ 341 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-20 - The word highlighter library for Vue 2 and Vue 3.
...
* [v-region](https://github.com/TerryZ/v-region) ⭐ 940 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-19 - A simple region selector, provide Chinese administrative division data.
...
* [vuedraggable-plus](https://github.com/Alfred-Skyblue/vue-draggable-plus) ⭐ 4,011 | 🐛 108 | 🌐 Vue | 📅 2026-03-13 - Vue component allowing drag-and-drop sorting module, support Vue>=v3 or Vue>=2.7. Based on Sortable.js.
...
* [tiptap](https://github.com/heyscrumpy/tiptap) ⭐ 38,084 | 🐛 846 | 🌐 TypeScript | 📅 2026-08-19 - A renderless and extendable rich-text editor for Vue.js
...
* [vue-froala-wysiwyg](https://github.com/froala/vue-froala-wysiwyg) ⭐ 3 | 🐛 88 | 🌐 JavaScript | 📅 2026-08-19 - Official VueJS plugin for Froala WYSIWIG HTML Editor.
...
* [vue-konva](https://github.com/rafaesc/vue-konva) ⭐ 1,353 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-14 - Vue & Canvas - JavaScript library for drawing complex canvas graphics using Vue.
...
* [FormKit](https://github.com/formkit/formkit) ⭐ 4,755 | 🐛 73 | 🌐 TypeScript | 📅 2026-07-24 - Vue 3 form development. 10x faster. Form inputs, validation, submission, error handling, generation, accessibility, theming, and more.
...
* [vest](https://github.com/ealush/vest) ⭐ 2,664 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-20 - 🦺 Declarative form validation framework inspired by unit testing.
* [vorms](https://github.com/Mini-ghost/vorms) ⭐ 720 | 🐛 16 | 🌐 TypeScript | 📅 2024-11-02 - Vue Form Validate with Composition API.
* [regle](https://github.com/victorgarciaesgi/regle) ⭐ 493 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-13 - ✅ Headless form validation library for Vue.js.
...
* [NotForm](https://github.com/favorodera/notform) ⭐ 21 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-17 - Headless, composable form validation for Vue.js. Bring your own UI and schema (Zod, Valibot, ArkType, or any Standard-Schema compliant validator).
...
* [validup](https://github.com/tada5hi/validup) ⭐ 4 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-18 - Composable, path-based validation with a Vue 3 composable (`@validup/vue`) for reactive forms, groups, and structured issues.
...
* [kitbag/router](https://github.com/kitbagjs/router) ⭐ 253 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-18 - A type safe router for vuejs
...
* [ssgoi](https://github.com/meursyphus/ssgoi) ⭐ 957 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-19 - Native app-like page transitions with spring physics, 60fps on mobile, SSR-ready, and all modern browser support
* [@lottiefiles/dotlottie-vue](https://github.com/LottieFiles/dotlottie-web) ⭐ 857 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-19 Official LottieFiles Vue component supporting the .lottie format (75% smaller files); convert and preview with [IconKing](https://iconking.net)
...
* [Unhead](https://github.com/unjs/unhead) ⭐ 1,302 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-20
...
* [lucide-motion-vue](https://github.com/respeak-io/lucide-motion-vue) ⭐ 51 | 🐛 2 | 🌐 Vue | 📅 2026-06-08 - 516 animated Lucide icons for Vue 3 with ergonomic hover/tap/viewport triggers and a composable `<AnimateIcon>` wrapper. Tree-shakable, one chunk per icon, TypeScript-first. (vue 3.x)
...
* [TresJs](https://github.com/tresjs/tres) ⭐ 3,661 | 🐛 97 | 🌐 Vue | 📅 2026-08-17 - Declarative ThreeJS using Vue Components
...
* [vueuse](https://github.com/vueuse/vueuse) ⭐ 22,328 | 🐛 365 | 🌐 TypeScript | 📅 2026-08-20 - Collection of essential Vue Composition API utils works for Vue 2.x and 3.x.
...
* [unplugin-auto-import](https://github.com/unplugin/unplugin-auto-import) ⭐ 3,792 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-03 - Auto import Vue APIs on-demand for Vite, Webpack and Rollup.
...
* [tanstack-query](https://github.com/tanstack/query) ⭐ 50,167 | 🐛 171 | 🌐 TypeScript | 📅 2026-08-20 - Powerful asynchronous state management.
...
* [@stitchapi/vue](https://github.com/rejifald/StitchAPI/tree/main/packages/vue) ⭐ 17 | 🐛 86 | 🌐 TypeScript | 📅 2026-08-18 - Streaming-first StitchAPI bindings: typed, validated `useStitch` / `useStitchStream` composables that re-render as response deltas arrive.
...
* [intlify/vue-i18n-next](https://github.com/intlify/vue-i18n-next) ⭐ 2,706 | 🐛 92 | 🌐 TypeScript | 📅 2026-08-17 - Vue I18n for Vue 3.
* [vue-intlayer](https://github.com/aymericzip/intlayer) ⭐ 798 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-20 - Intlayer i18n solution for vue 3.
...
* [fluent-vue](https://github.com/Demivan/fluent-vue) ⭐ 277 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-19 - Internationalization plugin for Vue.js (2 and 3). Vue.js integration for Fluent.js - JavaScript implementation of Project Fluent
* [tolgee/vue](https://github.com/tolgee/tolgee-js/tree/main/packages/vue) ⭐ 260 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-19 - Web-based localization tool enabling users to translate directly in the Vue 3 app they develop.
...
* [pinia](https://github.com/posva/pinia) ⭐ 14,700 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-12 - 🍍 Intuitive, type safe, light and flexible Store for Vue using the composition api with DevTools support.
...
* [pinia-persistedstate-2](https://github.com/iendeavor/pinia-plugin-persistedstate-2) ⭐ 116 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-19 - Persist and rehydrate your Pinia state between page reloads.
...
* [vue-apollo](https://github.com/Akryum/vue-apollo) ⭐ 6,033 | 🐛 275 | 🌐 TypeScript | 📅 2026-08-06 - Apollo/GraphQL integration for VueJS.
...
* [vue-types](https://github.com/dwightjack/vue-types) ⭐ 583 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-19 - Vue Prop Types definitions.
...
* [vue-recaptcha](https://github.com/DanSnow/vue-recaptcha) ⭐ 897 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-20 - Google reCAPTCHA component for Vue.js
...
* [@agentskit/vue](https://github.com/AgentsKit-io/agentskit) ⭐ 25 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-19 - Vue 3 composable and headless chat components for building AI agents, with streaming, tools, memory and RAG.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,456 | 🐛 92 | 🌐 TypeScript | 📅 2026-08-20 - Manage and reuse `vue` components between projects. Easily isolate and share components from any project without changing its source code, organize curated collections and install in different projects.
...
* [Vue Mess Detector](https://github.com/rrd108/vue-mess-detector) ⭐ 366 | 🐛 54 | 🌐 TypeScript | 📅 2026-08-18 - A static code analysis tool for 👉 detecting code smells and best practice violations in Vue.js and Nuxt.js projects
...
* [Heroshot](https://github.com/omachala/heroshot) ⭐ 72 | 🐛 4 | 🌐 TypeScript | 📅 2026-06-28 - Automate documentation screenshots with Vue component integration and theme-aware output.
...
* [vitest](https://github.com/vitest-dev/vitest) ⭐ 16,978 | 🐛 366 | 🌐 TypeScript | 📅 2026-08-20 - Next generation testing framework powered by Vite.
...
* [Vue Language Tools (Volar)](https://github.com/vuejs/language-tools) ⭐ 6,711 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-19 - ⚡The Fastest Vue Language Support Extension
...
* [Vue.js support for WebStorm](https://github.com/JetBrains/intellij-plugins/tree/master/vuejs) ⭐ 2,265 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-19, IntelliJ IDEA, PhpStorm, PyCharm & RubyMine – official Vue.js support by JetBrains
...
* [Vite](https://github.com/vitejs/vite) ⭐ 82,417 | 🐛 773 | 🌐 TypeScript | 📅 2026-08-20 - Next generation frontend tooling. It's fast!
* [vue-enterprise-boilerplate](https://github.com/bencodezen/vue-enterprise-boilerplate) ⭐ 7,777 | 🐛 7 | 🌐 SCSS | 📅 2026-01-26 - An ever-evolving, very opinionated architecture and dev environment for new Vue SPA projects using Vue CLI 3.
* [Create Vue](https://github.com/vuejs/create-vue) ⭐ 4,390 | 🐛 37 | 🌐 Vue | 📅 2026-08-17
* [vuesion](https://github.com/vuesion/vuesion) ⭐ 2,871 | 🐛 0 | 🌐 Vue | 📅 2026-08-18 - Vuesion is a boilerplate that helps product teams build faster than ever with fewer headaches and modern best practices across engineering & design.
...
* [electron-vite-vue](https://github.com/electron-vite/electron-vite-vue) ⭐ 4,892 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-01 - Really simple Electron + Vite + Vue boilerplate.
