...
## Awesome Vue.js [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@main/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,205 | 🐛 100 | 📅 2026-06-30 [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/vuejs/awesome-vue)
...
* [Release Notes](https://github.com/vuejs/core/releases) ⭐ 54,187 | 🐛 904 | 🌐 TypeScript | 📅 2026-08-16
* [Awesome Vite](https://github.com/vitejs/awesome-vite) ⭐ 17,220 | 🐛 131 | 🌐 JavaScript | 📅 2026-02-04
* [IDE Language Support](https://github.com/vuejs/language-tools?tab=readme-ov-file#vue-language-tools) ⭐ 6,709 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-15
...
* [unplugin-icons](https://github.com/unplugin/unplugin-icons) ⭐ 4,926 | 🐛 86 | 🌐 TypeScript | 📅 2026-01-14 - On-demand icon loader supporting all known popular icon sets
* [Vue DevTools](https://github.com/vuejs/devtools) ⭐ 2,887 | 🐛 233 | 🌐 TypeScript | 📅 2026-08-11 - Browser devtools extension for debugging Vue.js applications.
* [vue-i18n](https://github.com/intlify/vue-i18n) ⭐ 2,705 | 🐛 93 | 🌐 TypeScript | 📅 2026-08-15 - Internationalization plugin for Vue.js
...
* [TODOvue Blog](https://github.com/TODOvue/todo-vue) ⭐ 2 | 🐛 0 | 🌐 Vue | 📅 2026-08-15 - Guides and tutorials on creating modern components with Vue.js. [Website](https://todovue.blog/)
...
* [Vue.js TodoMVC](https://github.com/vuejs/vue/tree/dev/examples/todomvc) ⭐ 210,226 | 🐛 637 | 🌐 TypeScript | 📅 2024-10-10
...
* [Learning Vue 3.0](https://github.com/chengpeiquan/learning-vue3) ⭐ 1,488 | 🐛 14 | 🌐 TypeScript | 📅 2025-03-11
...
* [Vitesse Starter](https://github.com/antfu/vitesse) ⭐ 9,438 | 🐛 33 | 🌐 TypeScript | 📅 2026-02-25 ⛺️ Vue 3 starter inclode ( Layouts | i18n | UnoCSS | pinia | Markdown | Dark Mode | PWA | SSG | Component Auto-Importing | File-Based Router | Composition API | TypeScript)
...
* [umo editor](https://github.com/umodoc/editor) ⭐ 1,572 | 🐛 0 | 🌐 Vue | 📅 2026-08-12 - Umo Editor is an open-source document editor, based on Vue3 and Tiptap. Visit [Playground](https://demo.umodoc.com/editor?lang=en-US) for a fast experience.
...
* [vue-vuex-todomvc](https://github.com/bahmutov/vue-vuex-todomvc) ⭐ 48 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-15 - Example TodoMVC Vue.js app with Vuex store and server backend via REST and full set of E2E tests using [Cypress.io](https://www.cypress.io/) test runner.
...
* [slidev](https://github.com/slidevjs/slidev) ⭐ 48,097 | 🐛 207 | 🌐 TypeScript | 📅 2026-08-14 - Presentation Slides for Developers

* [YesPlayMusic](https://github.com/qier222/YesPlayMusic) ⭐ 33,150 | 🐛 652 | 🌐 Vue | 📅 2026-06-14 - High-looking third-party NetEase cloud player, support Windows / macOS / Linux :electron:

* [Wiki.js](https://github.com/Requarks/wiki) ⭐ 28,765 | 🐛 189 | 🌐 Vue | 📅 2026-08-15 - A modern, lightweight and powerful wiki app built on NodeJS, Git and Markdown

* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 27,977 | 🐛 31 | 🌐 PHP | 📅 2026-08-14 - A Free and Opensource Laravel eCommerce framework built for all to build and scale your business.

* [Dashy](https://github.com/lissy93/dashy) ⭐ 26,202 | 🐛 32 | 🌐 Vue | 📅 2026-08-15 - A self-hosted startpage, with an easy to use visual editor, status checking, themes, widgets and tons more

* [Stack Edit](https://github.com/benweet/stackedit/) ⭐ 23,063 | 🐛 732 | 🌐 JavaScript | 📅 2023-07-04 - In-browser Markdown editor

* [Daily](https://github.com/dailynowco/daily) ⭐ 20,017 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-12 - Curated dev news delivered to your new tab 👩🏽‍💻

* [Koel](https://github.com/phanan/koel) ⭐ 17,222 | 🐛 14 | 🌐 PHP | 📅 2026-08-10 - A personal music streaming server that works.

* [MyIP](https://github.com/jason5ng32/MyIP) ⭐ 11,597 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-15 - All in one IP Toolbox. Easy to check what's your IPs, IP geolocation, check for DNS leaks, examine WebRTC connections, speed test, ping test, MTR test, check website availability and more.

* [douyin](https://github.com/zyronon/douyin) ⭐ 11,525 | 🐛 24 | 🌐 Vue | 📅 2026-07-21 - Imitate TikTok ，Vue Best practices on Mobile
...
* [Akaunting](https://github.com/akaunting/akaunting) ⭐ 10,060 | 🐛 10 | 🌐 PHP | 📅 2026-08-13 - A free and online accounting software for small businesses and freelancers based on Laravel and VueJS.

* [nativescript-vue](https://github.com/rigor789/nativescript-vue) ⭐ 6,464 | 🐛 37 | 🌐 TypeScript | 📅 2025-10-17 - A Vue.js implementation of the NativeScript renderer.

* [Aimeos](https://github.com/aimeos/aimeos) ⭐ 5,446 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-29 - Leading Laravel eCommerce framework to build ultra fast online shops, marketplaces and complex B2B applications scalable from 1 to 1,000,000,000+ items

* [MQTTX](https://github.com/emqx/MQTTX) ⭐ 5,022 | 🐛 110 | 🌐 TypeScript | 📅 2026-08-13 - Cross-platform MQTT 5.0 desktop client built with Vue.js, Typescript and Electron.

* [astralapp](https://github.com/astralapp/astral) ⭐ 3,566 | 🐛 40 | 🌐 PHP | 📅 2026-07-11 - Organize Your GitHub Stars With Ease.

* [CoreUI Vue Admin Template](https://github.com/coreui/coreui-free-vue-admin-template) ⭐ 3,408 | 🐛 0 | 🌐 Vue | 📅 2026-08-14 - Open Source Admin Template powered by Vue.js

* [PJ Blog](https://github.com/jcc/blog) ⭐ 2,856 | 🐛 38 | 🌐 PHP | 📅 2023-06-08 - Open source blog built with Laravel and Vue.js.

* [Antares SQL](https://github.com/Fabio286/antares) ⭐ 2,644 | 🐛 149 | 🌐 Vue | 📅 2025-10-14 - Cross platform SQL client made to be simple and complete.
...
* [GrandNode 2.0](https://github.com/grandnode/grandnode2/) ⭐ 1,323 | 🐛 85 | 🌐 C# | 📅 2026-08-14 - Open Source Cross Platform E-Commerce Solution based on .NET Core 5.0 and MongoDB / Azure CosmosDB / Amazon DocumentDB / VueJS
...
* [LogChimp](https://github.com/logchimp/logchimp) ⭐ 1,116 | 🐛 186 | 🌐 TypeScript | 📅 2026-08-13 - Open-source software to track your customer's feedback to build better products.
...
* [MarkerOn](https://github.com/ifer47/markeron) ⭐ 892 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-13 - Lightweight screen annotation tool built with Tauri v2, Vue 3, and Canvas API for drawing, highlighting, and annotating anywhere on desktop.
...
* [Socialhome](https://github.com/jaywink/socialhome) ⭐ 384 | 🐛 127 | 🌐 Python | 📅 2026-08-15 - A federated rich profile builder with social networking features
...
* [Buefy Shop](https://github.com/14nrv/buefy-shop) ⭐ 260 | 🐛 2 | 🌐 JavaScript | 📅 2022-02-22 - Sample shop, open source, built with Nuxt, Stripe, Firebase, Bulma and Serverless Functions.

* [Pychat](https://github.com/akoidan/pychat) ⭐ 245 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-24 - Self-hosted webrtc video chat (an alternative to Slack)
...
* [Carpoolear](https://github.com/STS-Rosario/carpoolear) ⭐ 100 | 🐛 38 | 🌐 JavaScript | 📅 2026-08-15 - The open source Vue.js frontend (mobile and cordova app) for the argentinian carpooling application: [Carpoolear](https://carpoolear.com.ar)
...
* [NocoDB](https://github.com/nocodb/nocodb) ⭐ 64,546 | 🐛 701 | 🌐 TypeScript | 📅 2026-08-16 - An opensource Airtable alternative.
* [NxShell](https://github.com/nxshell/nxshell) ⭐ 1,253 | 🐛 147 | 🌐 JavaScript | 📅 2023-12-24 - An easy to use new terminal for SSH, which based on Electron and VueJS.
...
* [vuetify](https://github.com/vuetifyjs/vuetify) ⭐ 41,031 | 🐛 410 | 🌐 TypeScript | 📅 2026-08-16 - Material Component Framework for Vue.js 2.
* [Element Plus](https://github.com/element-plus/element-plus) ⭐ 27,671 | 🐛 1,200 | 🌐 TypeScript | 📅 2026-08-16 - A Vue 3 UI Framework.
* [quasar-framework](https://github.com/quasarframework/quasar) ⭐ 27,204 | 🐛 524 | 🌐 JavaScript | 📅 2026-08-14 - Quasar Framework. Build responsive websites, hybrid mobile Apps and Electron apps using same code, with Vue.js 3.
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,619 | 🐛 127 | 🌐 Vue | 📅 2026-08-15 - An enterprise-class UI components based on Ant Design and Vue 3.2.0
* [Naive UI](https://github.com/TuSimple/naive-ui) ⭐ 18,494 | 🐛 685 | 🌐 TypeScript | 📅 2026-08-10 - A Vue 3 Component Library Fairly Complete, Customizable Themes, Uses TypeScript, Not Too Slow Kinda Interesting
...
* [shadcn-vue](https://github.com/unovue/shadcn-vue) ⭐ 10,450 | 🐛 134 | 🌐 TypeScript | 📅 2026-08-15 - An unofficial, community-led Vue port of [shadcn/ui](https://github.com/shadcn-ui/ui) ⭐ 121,395 | 🐛 2,284 | 🌐 TypeScript | 📅 2026-08-13 (re-usable components built with Reka UI and Tailwind CSS).
* [buefy](https://github.com/rafaelpimpa/buefy) ⭐ 9,521 | 🐛 72 | 🌐 Vue | 📅 2026-08-11 - Components based on Bulma framework.
* [Nuxt UI](https://github.com/nuxt/ui) ⭐ 6,832 | 🐛 249 | 🌐 TypeScript | 📅 2026-08-14 - 125+ accessible and customizable components for Vue and Nuxt, built with Tailwind CSS and Reka UI.
* [Reka UI](https://github.com/unovue/reka-ui) ⭐ 6,719 | 🐛 303 | 🌐 Vue | 📅 2026-08-15 - An open-source library of unstyled, accessible UI primitives for building high-quality design systems and web apps in Vue 3 (formerly Radix Vue).
...
* [oruga](https://github.com/oruga-ui/oruga) ⭐ 1,166 | 🐛 21 | 🌐 Vue | 📅 2026-08-07 - UI components for Vue.js without CSS framework dependency.
...
* [flowbite-vue](https://github.com/themesberg/flowbite-vue) ⭐ 954 | 🐛 23 | 🌐 TypeScript | 📅 2026-07-28 - Vue component library based on Tailwind CSS
...
* [Ionic](https://github.com/ionic-team/ionic-framework) ⭐ 52,620 | 🐛 618 | 🌐 TypeScript | 📅 2026-08-15 - Mobile app development framework
* [uni-app](https://github.com/dcloudio/uni-app) ⭐ 41,598 | 🐛 699 | 🌐 Objective-C | 📅 2026-08-15 - A cross-platform framework using Vue.js
* [Framework7-Vue](https://github.com/framework7io/framework7) ⭐ 18,743 | 🐛 242 | 🌐 JavaScript | 📅 2026-07-28 - Build full-featured iOS & Android apps using Framework7 & Vue.
...
* [Native script](https://github.com/nativescript-vue/nativescript-vue) ⭐ 6,464 | 🐛 37 | 🌐 TypeScript | 📅 2025-10-17 - Native mobile applications using NativeScript

*Set of components for mobile*

* [vant](https://github.com/youzan/vant) ⭐ 24,361 | 🐛 216 | 🌐 TypeScript | 📅 2026-08-14 - A Vue.js 2.0 Mobile UI From YouZan.
...
* [uiv](https://github.com/uiv-lib/uiv) ⭐ 938 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-16 - Bootstrap3 components implemented by Vue2.
...
* [vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) ⭐ 33,137 | 🐛 77 | 🌐 Vue | 📅 2026-08-15 - A modern vue admin. It is based on Vue3, vite and TypeScript. It's fast！ [Live demo](https://vben.vvbin.cn/)
* [gin-vue-admin](https://github.com/flipped-aurora/gin-vue-admin) ⭐ 24,940 | 🐛 40 | 🌐 Go | 📅 2026-08-15 - 🚀Vite+Vue3+Gin development basic platform. [Live demo](https://demo.gin-vue-admin.com)
* [soybean-admin](https://github.com/soybeanjs/soybean-admin/blob/main/README.en_US.md) ⭐ 14,827 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-13 - A clean, elegant, beautiful and powerful admin template, based on Vue3, Vite5, TypeScript, Pinia, NaiveUI and UnoCSS.
...
* [Geeker-Admin](https://github.com/HalseySpicy/Geeker-Admin) ⭐ 8,065 | 🐛 78 | 🌐 Vue | 📅 2026-07-29 - A set of open source backend management framework based on Vue3 + TypeScript + Element Plus. [Live demo](https://admin.spicyboy.cn)
...
* [Tailmin](https://github.com/otezz/tailmin) ⭐ 60 | 🐛 0 | 🌐 Vue | 📅 2025-11-10 - Admin dashboard built with Vue.js and Tailwind CSS. [Live demo](https://tailmin.vercel.app/)
...
* [Nuxt.js](https://github.com/nuxt/nuxt.js) ⭐ 60,759 | 🐛 542 | 🌐 TypeScript | 📅 2026-08-15 - Versatile Vue.js Framework.

#### Static website generator

* [VuePress](https://github.com/vuejs/vuepress) ⭐ 22,743 | 🐛 607 | 🌐 JavaScript | 📅 2024-08-07 - Minimalistic Vue-powered static site generator.
* [VitePress](https://github.com/vuejs/vitepress) ⭐ 18,186 | 🐛 326 | 🌐 TypeScript | 📅 2026-08-15 - Vite & Vue powered static site generator.
...
* [CabloyJS](https://github.com/zhennann/cabloy) ⭐ 970 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-16 The Ultimate NodeJS Full Stack Business Development Platform, based on KoaJS & EggJS & VueJS & Framework7
...
* [vue-virtual-scroller](https://github.com/Akryum/vue-virtual-scroller) ⭐ 10,789 | 🐛 198 | 🌐 TypeScript | 📅 2026-08-12 - Component to scroll a large amount of elements efficiently (Vue 2.x).
...
* [splitpanes](https://github.com/antoniandre/splitpanes) ⭐ 2,250 | 🐛 24 | 🌐 Vue | 📅 2026-08-12 - A Vue JS reliable, simple and touch-ready panes splitter / resizer.
...
* [tanstack-table](https://github.com/tanstack/table) ⭐ 28,335 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-15 - Headless UI for building powerful tables & datagrids.
* [ag-grid-vue](https://github.com/ag-grid/ag-grid) ⭐ 15,544 | 🐛 147 | 🌐 TypeScript | 📅 2026-08-15 - Vue adaptor for ag-Grid.
* [vxe-table](https://github.com/x-extends/vxe-table) ⭐ 8,612 | 🐛 1,343 | 🌐 TypeScript | 📅 2026-08-15 - Vue form/table solution.
...
* [vue-datagrid](https://github.com/revolist/vue-datagrid) ⭐ 211 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-15 - Vue grid wrapper for powerful webcomponent revo-grid with excel like rich edit and behavior.
* [GridSheet](https://github.com/walkframe/gridsheet) ⭐ 194 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-15 - Highly customizable spreadsheet engine with formula support, multi-sheet references, and a Vue3 wrapper built on a Preact core.
* [Jordium Gantt Vue3](https://github.com/nelson820125/jordium-gantt-vue3) ⭐ 121 | 🐛 2 | 🌐 Vue | 📅 2026-08-05 - Vue3 Gantt chart component with Resource View, task dependencies, and project scheduling capabilities.
...
* [phantom-ui](https://github.com/Aejkatappaja/phantom-ui) ⭐ 780 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31 - Structure-aware skeleton loader web component that measures your real DOM, supports Vue, React, Svelte and plain HTML.
...
* [v-tooltip](https://github.com/Akryum/vue-tooltip) ⭐ 3,464 | 🐛 173 | 🌐 TypeScript | 📅 2026-07-31 - Easy tooltips with Vue 2.x.
...
* [v-viewer](https://github.com/mirari/v-viewer) ⭐ 2,640 | 🐛 36 | 🌐 Vue | 📅 2026-02-02 - Image viewer component for vue2 and vue3, supports rotation, scale, zoom and so on, based on [viewer.js](https://github.com/fengyuanchen/viewerjs) ⭐ 8,231 | 🐛 39 | 🌐 JavaScript | 📅 2026-07-18
...
* [swiper](https://github.com/nolimits4web/swiper) ⭐ 41,878 | 🐛 253 | 🌐 TypeScript | 📅 2026-08-06 - Official Swiper component for Vue 3. Tree shakable, SSR support, typing, a11y and a lot more
* [@egjs/vue-flicking](https://github.com/naver/egjs-flicking/blob/master/packages/vue3-flicking/README.md) ⭐ 2,922 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-11 - It's reliable, flexible and extendable carousel for Vue.js 2 & 3.
* [vue3-carousel](https://github.com/ismail9k/vue3-carousel) ⭐ 880 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-07 - A highly customizable, lightweight Vue 3 carousel component for your next awesome project.
...
* [vue-chartjs](https://github.com/apertureless/vue-chartjs) ⭐ 5,714 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-14 - Vue.js wrapper for Chart.js.
* [vue-data-ui](https://github.com/graphieros/vue-data-ui) ⭐ 2,439 | 🐛 0 | 🌐 Vue | 📅 2026-08-15 - Vue 3 chart library with 60+ components. Official site: <https://vue-data-ui.graphieros.com/>
* [vue-apexcharts](https://github.com/apexcharts/vue-apexcharts) ⭐ 1,344 | 🐛 9 | 🌐 Vue | 📅 2026-08-11 - Vue.js component for [ApexCharts](https://github.com/apexcharts/apexcharts.js) ⭐ 15,128 | 🐛 331 | 🌐 JavaScript | 📅 2026-08-15.
...
* [vue-timer-hook](https://github.com/riderx/vue-timer-hook) ⭐ 182 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-14 - Vue 3 Timer module inspired by react-timer-hook
...
* [schedule-x](https://github.com/schedule-x/schedule-x) ⭐ 2,528 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - A material design event calendar. Customizable, light- and dark modes & multilingual.
...
* [qalendar](https://github.com/tomosterlund/qalendar) ⭐ 292 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-14 - An event calendar and datepicker for Vue 3
...
* [vue-cesium](https://github.com/zouyaoji/vue-cesium) ⭐ 1,909 | 🐛 19 | 🌐 HTML | 📅 2026-07-30 - Vue 2.x & Vue 3.x components for Cesium.
...
* [virtua](https://github.com/inokawa/virtua) ⭐ 3,716 | 🐛 69 | 🌐 TypeScript | 📅 2026-08-16 - A zero-config, fast and small (\~3kB) virtual list component for React and Vue
...
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 2,888 | 🐛 0 | 🌐 Vue | 📅 2026-08-14 - Streaming Markdown renderer for Vue 3, Nuxt, and VitePress AI chat UIs, with support for incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [vue-flow](https://github.com/bcakmakoglu/vue-flow) ⭐ 6,781 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-14 - Interactive, customizeabe, graph & flowchart editor for Vue3
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,953 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - A lightweight Javascript library to easily create highly configurable and interactive particle animations
* [vue-advanced-chat](https://github.com/antoine92190/vue-advanced-chat) ⭐ 2,078 | 🐛 92 | 🌐 TypeScript | 📅 2026-08-10 - Feature-rich and fully customizable chat rooms component. Support files, images, videos, audio, emojis, customised actions, etc.
...
* [v-offline](https://github.com/vinayakkulkarni/v-offline) ⭐ 379 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-09 - Simple, tiny and easy to use detection of offline & online events for your Vue app (less than 390b minified)
...
* [vue-lumino](https://github.com/tupilabs/vue-lumino) ⭐ 99 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-15 - A component to use Vue.js with Jupyter Lumino (PhosphorJS), integrating DOM & VDOM through event listeners and Vue reactivity system.
...
* [form-create](https://github.com/xaboy/form-create) ⭐ 7,085 | 🐛 32 | 🌐 JavaScript | 📅 2026-08-09 - Form builder with dynamic rendering, data collection, validation, and submission capabilities, supporting json data
...
* [tiptap](https://github.com/heyscrumpy/tiptap) ⭐ 38,031 | 🐛 842 | 🌐 TypeScript | 📅 2026-08-15 - A renderless and extendable rich-text editor for Vue.js
...
* [vue-advanced-cropper](https://github.com/Norserium/vue-advanced-cropper) ⭐ 1,183 | 🐛 40 | 🌐 Vue | 📅 2024-06-09 - An advanced cropper that gives you opportunity to create almost any cropper that you desire
...
* [vee-validate](https://github.com/logaretm/vee-validate) ⭐ 11,260 | 🐛 171 | 🌐 TypeScript | 📅 2026-03-04 - Simple Vue.js input validation plugin.
...
* [vest](https://github.com/ealush/vest) ⭐ 2,664 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-16 - 🦺 Declarative form validation framework inspired by unit testing.
...
* [NotForm](https://github.com/favorodera/notform) ⭐ 18 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-15 - Headless, composable form validation for Vue.js. Bring your own UI and schema (Zod, Valibot, ArkType, or any Standard-Schema compliant validator).
...
* [validup](https://github.com/tada5hi/validup) ⭐ 4 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-14 - Composable, path-based validation with a Vue 3 composable (`@validup/vue`) for reactive forms, groups, and structured issues.
...
* [vue-router](https://github.com/vuejs/vue-router) ⭐ 18,872 | 🐛 125 | 🌐 JavaScript | 📅 2026-04-14 - The official router for Vue.js.
...
* [kitbag/router](https://github.com/kitbagjs/router) ⭐ 253 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-14 - A type safe router for vuejs
...
* [@formkit/auto-animate](https://github.com/formkit/auto-animate) ⭐ 13,902 | 🐛 42 | 🌐 TypeScript | 📅 2026-07-10 Add motion to your apps with a single line of code
...
* [@lottiefiles/dotlottie-vue](https://github.com/LottieFiles/dotlottie-web) ⭐ 852 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-13 Official LottieFiles Vue component supporting the .lottie format (75% smaller files); convert and preview with [IconKing](https://iconking.net)
...
* [Unhead](https://github.com/unjs/unhead) ⭐ 1,300 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-15
...
* [lucide-motion-vue](https://github.com/respeak-io/lucide-motion-vue) ⭐ 50 | 🐛 2 | 🌐 Vue | 📅 2026-06-08 - 516 animated Lucide icons for Vue 3 with ergonomic hover/tap/viewport triggers and a composable `<AnimateIcon>` wrapper. Tree-shakable, one chunk per icon, TypeScript-first. (vue 3.x)
...
* [TresJs](https://github.com/tresjs/tres) ⭐ 3,659 | 🐛 99 | 🌐 Vue | 📅 2026-08-15 - Declarative ThreeJS using Vue Components
...
* [vueuse](https://github.com/vueuse/vueuse) ⭐ 22,321 | 🐛 364 | 🌐 TypeScript | 📅 2026-08-13 - Collection of essential Vue Composition API utils works for Vue 2.x and 3.x.
* [unplugin-vue-components](https://github.com/unplugin/unplugin-vue-components) ⭐ 4,291 | 🐛 151 | 🌐 TypeScript | 📅 2026-05-20 - 📲 On-demand components auto importing for Vue.
* [unplugin-auto-import](https://github.com/unplugin/unplugin-auto-import) ⭐ 3,789 | 🐛 77 | 🌐 TypeScript | 📅 2026-08-03 - Auto import Vue APIs on-demand for Vite, Webpack and Rollup.
...
* [tanstack-query](https://github.com/tanstack/query) ⭐ 50,144 | 🐛 242 | 🌐 TypeScript | 📅 2026-08-13 - Powerful asynchronous state management.
...
* [@stitchapi/vue](https://github.com/rejifald/StitchAPI/tree/main/packages/vue) ⭐ 17 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-15 - Streaming-first StitchAPI bindings: typed, validated `useStitch` / `useStitchStream` composables that re-render as response deltas arrive.
...
* [intlify/vue-i18n-next](https://github.com/intlify/vue-i18n-next) ⭐ 2,705 | 🐛 93 | 🌐 TypeScript | 📅 2026-08-15 - Vue I18n for Vue 3.
* [vue-intlayer](https://github.com/aymericzip/intlayer) ⭐ 794 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-16 - Intlayer i18n solution for vue 3.
...
* [fluent-vue](https://github.com/Demivan/fluent-vue) ⭐ 276 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-15 - Internationalization plugin for Vue.js (2 and 3). Vue.js integration for Fluent.js - JavaScript implementation of Project Fluent
* [tolgee/vue](https://github.com/tolgee/tolgee-js/tree/main/packages/vue) ⭐ 260 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-14 - Web-based localization tool enabling users to translate directly in the Vue 3 app they develop.
...
* [pinia](https://github.com/posva/pinia) ⭐ 14,696 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-12 - 🍍 Intuitive, type safe, light and flexible Store for Vue using the composition api with DevTools support.
* [effector](https://github.com/zerobias/effector) ⭐ 4,845 | 🐛 158 | 🌐 TypeScript | 📅 2026-07-25 — Fast and powerful reactive state manager. Effector lets you write simple, fast and type safe code and manage reactive state with ease.
...
* [pinia-persistedstate-2](https://github.com/iendeavor/pinia-plugin-persistedstate-2) ⭐ 116 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-14 - Persist and rehydrate your Pinia state between page reloads.
...
* [eslint-plugin-vue](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,592 | 🐛 204 | 🌐 TypeScript | 📅 2026-08-15 - Eslint plugin for Vue.js projects.
* [vue-types](https://github.com/dwightjack/vue-types) ⭐ 583 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-15 - Vue Prop Types definitions.
* [vue-ts-types](https://github.com/FloEdelmann/vue-ts-types) ⭐ 13 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-14 - Lightweight TypeScript-first Vue prop type definitions.
...
* [vue-safe-html](https://github.com/ecosia/vue-safe-html) ⭐ 33 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-14 - Vue.js directive which renders sanitised HTML dynamically.
...
* [vue-stripe-checkout](https://github.com/jofftiquez/vue-stripe-checkout) ⭐ 1,127 | 🐛 24 | 🌐 Vue | 📅 2026-08-09 - A simple vue plugin for Stripe checkout.
...
* [vue-recaptcha](https://github.com/DanSnow/vue-recaptcha) ⭐ 897 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-15 - Google reCAPTCHA component for Vue.js
* [vue-tg](https://github.com/deptyped/vue-telegram) ⭐ 280 | 🐛 16 | 🌐 TypeScript | 📅 2026-03-03 - Telegram Web Apps integration for Vue 3.
* [vue-postgrest](https://github.com/technowledgy/vue-postgrest) ⭐ 91 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-14 - Vue.js integration for postgREST: flexible, powerful and easy to use.
...
* [@agentskit/vue](https://github.com/AgentsKit-io/agentskit) ⭐ 23 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-15 - Vue 3 composable and headless chat components for building AI agents, with streaming, tools, memory and RAG.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,455 | 🐛 104 | 🌐 TypeScript | 📅 2026-08-15 - Manage and reuse `vue` components between projects. Easily isolate and share components from any project without changing its source code, organize curated collections and install in different projects.
...
* [Vue Mess Detector](https://github.com/rrd108/vue-mess-detector) ⭐ 366 | 🐛 54 | 🌐 TypeScript | 📅 2026-08-14 - A static code analysis tool for 👉 detecting code smells and best practice violations in Vue.js and Nuxt.js projects
...
* [vite-plugin-vue-inspector](https://github.com/webfansplz/vite-plugin-vue-inspector) ⭐ 805 | 🐛 44 | 🌐 TypeScript | 📅 2026-06-08 - jump to editor source code while click the element of browser automatically.
...
* [vitest](https://github.com/vitest-dev/vitest) ⭐ 16,956 | 🐛 383 | 🌐 TypeScript | 📅 2026-08-14 - Next generation testing framework powered by Vite.
...
* [vue-hubble](https://github.com/crishellco/vue-hubble) ⭐ 13 | 🐛 22 | 🌐 JavaScript | 📅 2026-08-14 - A better way to select elements for UI testing in Vue.
...
* [Vim Vue](https://github.com/posva/vim-vue) ⭐ 1,279 | 🐛 31 | 🌐 Vim Script | 📅 2024-03-30 - Syntax Highlight for Vue.js components.

##### Visual Studio Code

* [Vue Language Tools (Volar)](https://github.com/vuejs/language-tools) ⭐ 6,709 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-15 - ⚡The Fastest Vue Language Support Extension
...
* [Vue.js support for WebStorm](https://github.com/JetBrains/intellij-plugins/tree/master/vuejs) ⭐ 2,265 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-15, IntelliJ IDEA, PhpStorm, PyCharm & RubyMine – official Vue.js support by JetBrains
...
* [Vite](https://github.com/vitejs/vite) ⭐ 82,358 | 🐛 793 | 🌐 TypeScript | 📅 2026-08-15 - Next generation frontend tooling. It's fast!
...
* [Create Vue](https://github.com/vuejs/create-vue) ⭐ 4,387 | 🐛 36 | 🌐 Vue | 📅 2026-08-15
...
* [Vue.js/Nuxt.js full-featured boilerplate](https://github.com/GrabarzUndPartner/gp-vue-boilerplate) ⭐ 129 | 🐛 11 | 🌐 Vue | 📅 2026-08-14 - professional agency frontend template for building fast, robust, and adaptable web apps or sites by vuejs/nuxtjs.
