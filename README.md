...
## Awesome Vue.js [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@main/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,166 | 🐛 106 | 📅 2026-09-02 [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/vuejs/awesome-vue)
...
* [Release Notes](https://github.com/vuejs/core/releases) ⭐ 54,430 | 🐛 891 | 🌐 TypeScript | 📅 2026-09-23
* [Awesome Vite](https://github.com/vitejs/awesome-vite) ⭐ 17,253 | 🐛 140 | 🌐 JavaScript | 📅 2026-02-04
* [IDE Language Support](https://github.com/vuejs/language-tools?tab=readme-ov-file#vue-language-tools) ⭐ 6,719 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-21
...
* [unplugin-icons](https://github.com/unplugin/unplugin-icons) ⭐ 4,939 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-11 - On-demand icon loader supporting all known popular icon sets
* [Vue DevTools](https://github.com/vuejs/devtools) ⭐ 2,913 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-22 - Browser devtools extension for debugging Vue.js applications.
* [vue-i18n](https://github.com/intlify/vue-i18n) ⭐ 2,711 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-22 - Internationalization plugin for Vue.js
...
* [Help you learn more efficiently vue3 source code - mini-vue](https://github.com/cuixiaorui/mini-vue) ⭐ 10,540 | 🐛 27 | 🌐 TypeScript | 📅 2024-03-25 by cuixiaorui
* [Vue.js debugging in Chrome and VS Code](https://github.com/Microsoft/vscode-recipes/tree/master/vuejs-cli) ⭐ 5,959 | 🐛 40 | 🌐 JavaScript | 📅 2026-03-30 This recipe shows how to use the Debugger for Chrome extension with VS Code to debug Vue.js applications generated by the Vue CLI.
...
* [umo editor](https://github.com/umodoc/editor) ⭐ 1,602 | 🐛 1 | 🌐 Vue | 📅 2026-09-16 - Umo Editor is an open-source document editor, based on Vue3 and Tiptap. Visit [Playground](https://demo.umodoc.com/editor?lang=en-US) for a fast experience.
...
* [slidev](https://github.com/slidevjs/slidev) ⭐ 48,809 | 🐛 206 | 🌐 TypeScript | 📅 2026-09-16 - Presentation Slides for Developers

* [YesPlayMusic](https://github.com/qier222/YesPlayMusic) ⭐ 33,310 | 🐛 652 | 🌐 Vue | 📅 2026-06-14 - High-looking third-party NetEase cloud player, support Windows / macOS / Linux :electron:

* [Wiki.js](https://github.com/Requarks/wiki) ⭐ 28,953 | 🐛 182 | 🌐 Vue | 📅 2026-09-22 - A modern, lightweight and powerful wiki app built on NodeJS, Git and Markdown

* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 28,159 | 🐛 22 | 🌐 PHP | 📅 2026-09-23 - A Free and Opensource Laravel eCommerce framework built for all to build and scale your business.

* [Dashy](https://github.com/lissy93/dashy) ⭐ 26,549 | 🐛 26 | 🌐 Vue | 📅 2026-09-22 - A self-hosted startpage, with an easy to use visual editor, status checking, themes, widgets and tons more

* [Stack Edit](https://github.com/benweet/stackedit/) ⭐ 23,102 | 🐛 728 | 🌐 JavaScript | 📅 2023-07-04 - In-browser Markdown editor

* [Daily](https://github.com/dailynowco/daily) ⭐ 20,071 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-14 - Curated dev news delivered to your new tab 👩🏽‍💻

* [Koel](https://github.com/phanan/koel) ⭐ 17,259 | 🐛 19 | 🌐 PHP | 📅 2026-09-23 - A personal music streaming server that works.

* [MyIP](https://github.com/jason5ng32/MyIP) ⭐ 11,941 | 🐛 23 | 🌐 JavaScript | 📅 2026-09-22 - All in one IP Toolbox. Easy to check what's your IPs, IP geolocation, check for DNS leaks, examine WebRTC connections, speed test, ping test, MTR test, check website availability and more.
...
* [Akaunting](https://github.com/akaunting/akaunting) ⭐ 10,132 | 🐛 8 | 🌐 PHP | 📅 2026-09-21 - A free and online accounting software for small businesses and freelancers based on Laravel and VueJS.
...
* [Aimeos](https://github.com/aimeos/aimeos) ⭐ 5,457 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-29 - Leading Laravel eCommerce framework to build ultra fast online shops, marketplaces and complex B2B applications scalable from 1 to 1,000,000,000+ items

* [MQTTX](https://github.com/emqx/MQTTX) ⭐ 5,064 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-23 - Cross-platform MQTT 5.0 desktop client built with Vue.js, Typescript and Electron.
...
* [Antares SQL](https://github.com/Fabio286/antares) ⭐ 2,653 | 🐛 148 | 🌐 Vue | 📅 2025-10-14 - Cross platform SQL client made to be simple and complete.
...
* [GrandNode 2.0](https://github.com/grandnode/grandnode2/) ⭐ 1,329 | 🐛 88 | 🌐 C# | 📅 2026-09-23 - Open Source Cross Platform E-Commerce Solution based on .NET Core 5.0 and MongoDB / Azure CosmosDB / Amazon DocumentDB / VueJS
...
* [LogChimp](https://github.com/logchimp/logchimp) ⭐ 1,131 | 🐛 170 | 🌐 TypeScript | 📅 2026-09-23 - Open-source software to track your customer's feedback to build better products.
...
* [MarkerOn](https://github.com/ifer47/markeron) ⭐ 1,056 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-07 - Lightweight screen annotation tool built with Tauri v2, Vue 3, and Canvas API for drawing, highlighting, and annotating anywhere on desktop.
...
* [Carpoolear](https://github.com/STS-Rosario/carpoolear) ⭐ 101 | 🐛 40 | 🌐 JavaScript | 📅 2026-09-22 - The open source Vue.js frontend (mobile and cordova app) for the argentinian carpooling application: [Carpoolear](https://carpoolear.com.ar)
...
* [Interface X](https://github.com/empathyco/x) ⭐ 84 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-23 - UI Search\&Discovery components to rapidly build beautiful search experiences

* [DentalPin](https://github.com/martinezsalmeron/dentalpin) ⭐ 81 | 🐛 34 | 🌐 Python | 📅 2026-09-22 - Dental clinic management platform with appointment scheduling and a modular plugin architecture, built with Nuxt 3 and FastAPI.
...
* [fresfolio](https://github.com/dkioroglou/fresfolio) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-19 - a browser-based note-taking app for managing personal and research projects. The app uses Flask as backend and Vue.js as frontend leveraging the Quasar framework for UI components and responsive design.
...
* [NocoDB](https://github.com/nocodb/nocodb) ⭐ 65,047 | 🐛 717 | 🌐 TypeScript | 📅 2026-09-23 - An opensource Airtable alternative.
...
* [vuetify](https://github.com/vuetifyjs/vuetify) ⭐ 41,045 | 🐛 400 | 🌐 TypeScript | 📅 2026-09-22 - Material Component Framework for Vue.js 2.
* [Element Plus](https://github.com/element-plus/element-plus) ⭐ 27,779 | 🐛 1,159 | 🌐 TypeScript | 📅 2026-09-23 - A Vue 3 UI Framework.
* [quasar-framework](https://github.com/quasarframework/quasar) ⭐ 27,218 | 🐛 68 | 🌐 JavaScript | 📅 2026-09-22 - Quasar Framework. Build responsive websites, hybrid mobile Apps and Electron apps using same code, with Vue.js 3.
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,663 | 🐛 128 | 🌐 Vue | 📅 2026-09-19 - An enterprise-class UI components based on Ant Design and Vue 3.2.0
* [Naive UI](https://github.com/TuSimple/naive-ui) ⭐ 18,561 | 🐛 695 | 🌐 TypeScript | 📅 2026-08-27 - A Vue 3 Component Library Fairly Complete, Customizable Themes, Uses TypeScript, Not Too Slow Kinda Interesting
* [BootstrapVue](https://github.com/bootstrap-vue/bootstrap-vue) ⭐ 14,425 | 🐛 201 | 🌐 JavaScript | 📅 2026-04-02 - Bootstrap v4 components and grid system for Vue.js.
* [shadcn-vue](https://github.com/unovue/shadcn-vue) ⭐ 10,616 | 🐛 144 | 🌐 TypeScript | 📅 2026-09-22 - An unofficial, community-led Vue port of [shadcn/ui](https://github.com/shadcn-ui/ui) ⭐ 124,451 | 🐛 1,837 | 🌐 TypeScript | 📅 2026-09-21 (re-usable components built with Reka UI and Tailwind CSS).
* [buefy](https://github.com/rafaelpimpa/buefy) ⭐ 9,513 | 🐛 72 | 🌐 Vue | 📅 2026-09-08 - Components based on Bulma framework.
* [Nuxt UI](https://github.com/nuxt/ui) ⭐ 6,953 | 🐛 240 | 🌐 TypeScript | 📅 2026-09-23 - 125+ accessible and customizable components for Vue and Nuxt, built with Tailwind CSS and Reka UI.
* [Reka UI](https://github.com/unovue/reka-ui) ⭐ 6,828 | 🐛 287 | 🌐 Vue | 📅 2026-09-23 - An open-source library of unstyled, accessible UI primitives for building high-quality design systems and web apps in Vue 3 (formerly Radix Vue).
* [vuestic-ui](https://github.com/epicmaxco/vuestic-ui) ⭐ 3,746 | 🐛 530 | 🌐 Vue | 📅 2026-05-09 - A Vue.js 3.0 UI customizable UI Framework.
...
* [Ionic](https://github.com/ionic-team/ionic-framework) ⭐ 52,677 | 🐛 583 | 🌐 TypeScript | 📅 2026-09-23 - Mobile app development framework
* [uni-app](https://github.com/dcloudio/uni-app) ⭐ 41,618 | 🐛 706 | 🌐 JavaScript | 📅 2026-09-23 - A cross-platform framework using Vue.js
* [Framework7-Vue](https://github.com/framework7io/framework7) ⭐ 18,759 | 🐛 241 | 🌐 JavaScript | 📅 2026-09-08 - Build full-featured iOS & Android apps using Framework7 & Vue.
...
* [uiv](https://github.com/uiv-lib/uiv) ⭐ 937 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-22 - Bootstrap3 components implemented by Vue2.
...
* [vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) ⭐ 33,507 | 🐛 47 | 🌐 Vue | 📅 2026-09-22 - A modern vue admin. It is based on Vue3, vite and TypeScript. It's fast！ [Live demo](https://vben.vvbin.cn/)
* [gin-vue-admin](https://github.com/flipped-aurora/gin-vue-admin) ⭐ 25,045 | 🐛 42 | 🌐 Go | 📅 2026-09-20 - 🚀Vite+Vue3+Gin development basic platform. [Live demo](https://demo.gin-vue-admin.com)
* [soybean-admin](https://github.com/soybeanjs/soybean-admin/blob/main/README.en_US.md) ⭐ 15,034 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-07 - A clean, elegant, beautiful and powerful admin template, based on Vue3, Vite5, TypeScript, Pinia, NaiveUI and UnoCSS.
...
* [Nuxt.js](https://github.com/nuxt/nuxt.js) ⭐ 60,892 | 🐛 473 | 🌐 TypeScript | 📅 2026-09-23 - Versatile Vue.js Framework.
...
* [VitePress](https://github.com/vuejs/vitepress) ⭐ 18,347 | 🐛 312 | 🌐 TypeScript | 📅 2026-09-22 - Vite & Vue powered static site generator.
...
* [Fes.js](https://github.com/WeBankFinTech/fes.js/blob/master/README.en-US.md) ⭐ 1,655 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-14 - An easy-to-use front-end application framework based on vue3.
* [CabloyJS](https://github.com/zhennann/cabloy) ⭐ 971 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 The Ultimate NodeJS Full Stack Business Development Platform, based on KoaJS & EggJS & VueJS & Framework7
...
* [vue-virtual-scroller](https://github.com/Akryum/vue-virtual-scroller) ⭐ 10,797 | 🐛 201 | 🌐 TypeScript | 📅 2026-08-12 - Component to scroll a large amount of elements efficiently (Vue 2.x).
...
* [tanstack-table](https://github.com/tanstack/table) ⭐ 28,447 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-16 - Headless UI for building powerful tables & datagrids.
* [ag-grid-vue](https://github.com/ag-grid/ag-grid) ⭐ 15,612 | 🐛 112 | 🌐 TypeScript | 📅 2026-09-23 - Vue adaptor for ag-Grid.
* [vxe-table](https://github.com/x-extends/vxe-table) ⭐ 8,627 | 🐛 1,351 | 🌐 TypeScript | 📅 2026-09-21 - Vue form/table solution.
...
* [phantom-ui](https://github.com/Aejkatappaja/phantom-ui) ⭐ 799 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31 - Structure-aware skeleton loader web component that measures your real DOM, supports Vue, React, Svelte and plain HTML.
...
* [v-viewer](https://github.com/mirari/v-viewer) ⭐ 2,639 | 🐛 36 | 🌐 Vue | 📅 2026-02-02 - Image viewer component for vue2 and vue3, supports rotation, scale, zoom and so on, based on [viewer.js](https://github.com/fengyuanchen/viewerjs) ⭐ 8,239 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-13
...
* [vue3-carousel](https://github.com/ismail9k/vue3-carousel) ⭐ 885 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-23 - A highly customizable, lightweight Vue 3 carousel component for your next awesome project.
...
* [vue-echarts](https://github.com/ecomfe/vue-echarts) ⭐ 10,759 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-22 - Vue.js component for Apache ECharts™.
* [vue-chartjs](https://github.com/apertureless/vue-chartjs) ⭐ 5,718 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-15 - Vue.js wrapper for Chart.js.
* [vue-data-ui](https://github.com/graphieros/vue-data-ui) ⭐ 2,450 | 🐛 0 | 🌐 Vue | 📅 2026-09-22 - Vue 3 chart library with 60+ components. Official site: <https://vue-data-ui.graphieros.com/>
* [vue-apexcharts](https://github.com/apexcharts/vue-apexcharts) ⭐ 1,341 | 🐛 5 | 🌐 Vue | 📅 2026-09-16 - Vue.js component for [ApexCharts](https://github.com/apexcharts/apexcharts.js) ⭐ 15,159 | 🐛 301 | 🌐 JavaScript | 📅 2026-09-23.
...
* [schedule-x](https://github.com/schedule-x/schedule-x) ⭐ 2,584 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-22 - A material design event calendar. Customizable, light- and dark modes & multilingual.
...
* [qalendar](https://github.com/tomosterlund/qalendar) ⭐ 293 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-22 - An event calendar and datepicker for Vue 3
...
* [map-chart](https://github.com/noeGnh/map-chart) ⭐ 13 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-17 - Vue 3 and React components for displaying dynamic data on a world, continents, countries and custom maps.
...
* [virtua](https://github.com/inokawa/virtua) ⭐ 3,748 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-23 - A zero-config, fast and small (\~3kB) virtual list component for React and Vue
...
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 3,019 | 🐛 2 | 🌐 Vue | 📅 2026-09-22 - Streaming Markdown renderer for Vue 3, Nuxt, and VitePress AI chat UIs, with support for incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [vue-pdf-embed](https://github.com/hrynko/vue-pdf-embed) ⭐ 1,040 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-25 - PDF embed component for Vue 2 and Vue 3
...
* [@jasy/vue](https://github.com/jasy-pdf/jasy/tree/main/packages/vue) ⭐ 87 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-11 - Author PDFs as Vue 3 components and render them straight in the browser, no headless browser required. Real layout, pagination and tables, with XRechnung and ZUGFeRD e-invoicing out of the box (Nuxt module available).
...
* [vue-flow](https://github.com/bcakmakoglu/vue-flow) ⭐ 6,874 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-14 - Interactive, customizeabe, graph & flowchart editor for Vue3
...
* [vue3-social-sharing](https://github.com/hedint/vue3-social-sharing) ⭐ 23 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-18 - Style agnostic Vue 3 plugin for social sharing your links on major social networks.
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,985 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-22 - A lightweight Javascript library to easily create highly configurable and interactive particle animations
...
* [vue-scroll-picker](https://github.com/wan2land/vue-scroll-picker) ⭐ 294 | 🐛 7 | 🌐 Vue | 📅 2026-09-18 - A scroll picker component for Vue 2.x. Support all gestures of mouse(also wheel) and touch.
...
* [form-create](https://github.com/xaboy/form-create) ⭐ 7,102 | 🐛 33 | 🌐 JavaScript | 📅 2026-09-14 - Form builder with dynamic rendering, data collection, validation, and submission capabilities, supporting json data
...
* [tiptap](https://github.com/heyscrumpy/tiptap) ⭐ 38,491 | 🐛 831 | 🌐 TypeScript | 📅 2026-09-22 - A renderless and extendable rich-text editor for Vue.js
...
* [blok](https://github.com/JackUait/blok) ⭐ 37 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - Headless block-based rich text editor with a Vue 3 adapter, outputs JSON instead of HTML.
...
* [vest](https://github.com/ealush/vest) ⭐ 2,662 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-23 - 🦺 Declarative form validation framework inspired by unit testing.
...
* [NotForm](https://github.com/favorodera/notform) ⭐ 21 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-21 - Headless, composable form validation for Vue.js. Bring your own UI and schema (Zod, Valibot, ArkType, or any Standard-Schema compliant validator).
...
* [kitbag/router](https://github.com/kitbagjs/router) ⭐ 253 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-23 - A type safe router for vuejs
...
* [@formkit/auto-animate](https://github.com/formkit/auto-animate) ⭐ 13,922 | 🐛 44 | 🌐 TypeScript | 📅 2026-07-10 Add motion to your apps with a single line of code
...
* [Unhead](https://github.com/unjs/unhead) ⭐ 1,305 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-21
...
* [TresJs](https://github.com/tresjs/tres) ⭐ 3,736 | 🐛 109 | 🌐 Vue | 📅 2026-09-23 - Declarative ThreeJS using Vue Components
...
* [vueuse](https://github.com/vueuse/vueuse) ⭐ 22,380 | 🐛 376 | 🌐 TypeScript | 📅 2026-09-19 - Collection of essential Vue Composition API utils works for Vue 2.x and 3.x.
* [unplugin-vue-components](https://github.com/unplugin/unplugin-vue-components) ⭐ 4,293 | 🐛 148 | 🌐 TypeScript | 📅 2026-05-20 - 📲 On-demand components auto importing for Vue.
* [unplugin-auto-import](https://github.com/unplugin/unplugin-auto-import) ⭐ 3,798 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-03 - Auto import Vue APIs on-demand for Vite, Webpack and Rollup.
...
* [tanstack-query](https://github.com/tanstack/query) ⭐ 50,347 | 🐛 158 | 🌐 TypeScript | 📅 2026-09-23 - Powerful asynchronous state management.
...
* [@stitchapi/vue](https://github.com/rejifald/StitchAPI/tree/main/packages/vue) ⭐ 18 | 🐛 80 | 🌐 TypeScript | 📅 2026-09-21 - Streaming-first StitchAPI bindings: typed, validated `useStitch` / `useStitchStream` composables that re-render as response deltas arrive.
...
* [intlify/vue-i18n-next](https://github.com/intlify/vue-i18n-next) ⭐ 2,711 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-22 - Vue I18n for Vue 3.
* [vue-intlayer](https://github.com/aymericzip/intlayer) ⭐ 836 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-23 - Intlayer i18n solution for vue 3.
...
* [fluent-vue](https://github.com/Demivan/fluent-vue) ⭐ 279 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-20 - Internationalization plugin for Vue.js (2 and 3). Vue.js integration for Fluent.js - JavaScript implementation of Project Fluent
* [tolgee/vue](https://github.com/tolgee/tolgee-js/tree/main/packages/vue) ⭐ 260 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-22 - Web-based localization tool enabling users to translate directly in the Vue 3 app they develop.
...
* [eslint-plugin-vue](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,590 | 🐛 209 | 🌐 TypeScript | 📅 2026-09-12 - Eslint plugin for Vue.js projects.
...
* [vue-postgrest](https://github.com/technowledgy/vue-postgrest) ⭐ 91 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-19 - Vue.js integration for postgREST: flexible, powerful and easy to use.
...
* [Vue Mess Detector](https://github.com/rrd108/vue-mess-detector) ⭐ 365 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-21 - A static code analysis tool for 👉 detecting code smells and best practice violations in Vue.js and Nuxt.js projects
...
* [Poveste](https://github.com/poveste-dev/poveste) ⭐ 3 | 🐛 121 | 🌐 TypeScript | 📅 2026-09-23 - Interactive component playgrounds powered by Vite. A drop-in fork of histoire, with Vue 3 and Nuxt support.
...
* [vitest](https://github.com/vitest-dev/vitest) ⭐ 17,150 | 🐛 440 | 🌐 TypeScript | 📅 2026-09-23 - Next generation testing framework powered by Vite.
...
* [Vue Language Tools (Volar)](https://github.com/vuejs/language-tools) ⭐ 6,719 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-21 - ⚡The Fastest Vue Language Support Extension
...
* [Vue.js support for WebStorm](https://github.com/JetBrains/intellij-plugins/tree/master/vuejs) ⭐ 2,271 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-23, IntelliJ IDEA, PhpStorm, PyCharm & RubyMine – official Vue.js support by JetBrains
...
* [Vite](https://github.com/vitejs/vite) ⭐ 82,961 | 🐛 794 | 🌐 TypeScript | 📅 2026-09-23 - Next generation frontend tooling. It's fast!
...
* [Extension.js](https://github.com/extension-js/extension.js) ⭐ 5,172 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-22 - Build cross-browser extensions with Vue, no config, one manifest for Chrome, Edge, Firefox and Safari.
* [Create Vue](https://github.com/vuejs/create-vue) ⭐ 4,405 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-23
...
* [Vue.js/Nuxt.js full-featured boilerplate](https://github.com/GrabarzUndPartner/gp-vue-boilerplate) ⭐ 128 | 🐛 11 | 🌐 Vue | 📅 2026-09-21 - professional agency frontend template for building fast, robust, and adaptable web apps or sites by vuejs/nuxtjs.
