...
## Awesome Vue.js [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@main/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,835 | 🐛 105 | 📅 2026-08-21 [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/vuejs/awesome-vue)
...
* [Release Notes](https://github.com/vuejs/core/releases) ⭐ 54,287 | 🐛 900 | 🌐 TypeScript | 📅 2026-09-01
* [Awesome Vite](https://github.com/vitejs/awesome-vite) ⭐ 17,233 | 🐛 135 | 🌐 JavaScript | 📅 2026-02-04
* [IDE Language Support](https://github.com/vuejs/language-tools?tab=readme-ov-file#vue-language-tools) ⭐ 6,716 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-01
...
* [vue-i18n](https://github.com/intlify/vue-i18n) ⭐ 2,711 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-01 - Internationalization plugin for Vue.js
...
* [Vue.js TodoMVC](https://github.com/vuejs/vue/tree/dev/examples/todomvc) ⭐ 211,260 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10
...
* [umo editor](https://github.com/umodoc/editor) ⭐ 1,587 | 🐛 1 | 🌐 Vue | 📅 2026-09-01 - Umo Editor is an open-source document editor, based on Vue3 and Tiptap. Visit [Playground](https://demo.umodoc.com/editor?lang=en-US) for a fast experience.
...
* [slidev](https://github.com/slidevjs/slidev) ⭐ 48,372 | 🐛 224 | 🌐 TypeScript | 📅 2026-08-25 - Presentation Slides for Developers

* [YesPlayMusic](https://github.com/qier222/YesPlayMusic) ⭐ 33,235 | 🐛 654 | 🌐 Vue | 📅 2026-06-14 - High-looking third-party NetEase cloud player, support Windows / macOS / Linux :electron:

* [Wiki.js](https://github.com/Requarks/wiki) ⭐ 28,825 | 🐛 189 | 🌐 Vue | 📅 2026-08-30 - A modern, lightweight and powerful wiki app built on NodeJS, Git and Markdown

* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 28,085 | 🐛 30 | 🌐 PHP | 📅 2026-09-01 - A Free and Opensource Laravel eCommerce framework built for all to build and scale your business.

* [Dashy](https://github.com/lissy93/dashy) ⭐ 26,347 | 🐛 32 | 🌐 Vue | 📅 2026-08-31 - A self-hosted startpage, with an easy to use visual editor, status checking, themes, widgets and tons more

* [Stack Edit](https://github.com/benweet/stackedit/) ⭐ 23,079 | 🐛 732 | 🌐 JavaScript | 📅 2023-07-04 - In-browser Markdown editor
...
* [MyIP](https://github.com/jason5ng32/MyIP) ⭐ 11,786 | 🐛 24 | 🌐 JavaScript | 📅 2026-08-31 - All in one IP Toolbox. Easy to check what's your IPs, IP geolocation, check for DNS leaks, examine WebRTC connections, speed test, ping test, MTR test, check website availability and more.
...
* [Akaunting](https://github.com/akaunting/akaunting) ⭐ 10,101 | 🐛 12 | 🌐 PHP | 📅 2026-08-31 - A free and online accounting software for small businesses and freelancers based on Laravel and VueJS.

* [nativescript-vue](https://github.com/rigor789/nativescript-vue) ⭐ 6,462 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-26 - A Vue.js implementation of the NativeScript renderer.
...
* [MQTTX](https://github.com/emqx/MQTTX) ⭐ 5,037 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-17 - Cross-platform MQTT 5.0 desktop client built with Vue.js, Typescript and Electron.

* [astralapp](https://github.com/astralapp/astral) ⭐ 3,572 | 🐛 40 | 🌐 PHP | 📅 2026-07-11 - Organize Your GitHub Stars With Ease.
...
* [MarkerOn](https://github.com/ifer47/markeron) ⭐ 980 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-31 - Lightweight screen annotation tool built with Tauri v2, Vue 3, and Canvas API for drawing, highlighting, and annotating anywhere on desktop.
...
* [Balancer](https://github.com/balancer-labs/frontend-v2) ⚠️ Archived - A Decentralized Finance app that runs on Ethereum.
...
* [CodeceptJS UI](https://github.com/codecept-js/ui) ⭐ 84 | 🐛 24 | 🌐 JavaScript | 📅 2026-08-31 - Cypress-liked UI for ✔️ CodeceptJS end 2 end tests ✔️.

* [Interface X](https://github.com/empathyco/x) ⭐ 84 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-31 - UI Search\&Discovery components to rapidly build beautiful search experiences
...
* [NocoDB](https://github.com/nocodb/nocodb) ⭐ 64,794 | 🐛 711 | 🌐 TypeScript | 📅 2026-09-01 - An opensource Airtable alternative.
...
* [vuetify](https://github.com/vuetifyjs/vuetify) ⭐ 41,041 | 🐛 394 | 🌐 TypeScript | 📅 2026-09-01 - Material Component Framework for Vue.js 2.
* [Element Plus](https://github.com/element-plus/element-plus) ⭐ 27,725 | 🐛 1,193 | 🌐 TypeScript | 📅 2026-08-31 - A Vue 3 UI Framework.
...
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,637 | 🐛 123 | 🌐 Vue | 📅 2026-08-26 - An enterprise-class UI components based on Ant Design and Vue 3.2.0
* [Naive UI](https://github.com/TuSimple/naive-ui) ⭐ 18,522 | 🐛 699 | 🌐 TypeScript | 📅 2026-08-27 - A Vue 3 Component Library Fairly Complete, Customizable Themes, Uses TypeScript, Not Too Slow Kinda Interesting
...
* [shadcn-vue](https://github.com/unovue/shadcn-vue) ⭐ 10,526 | 🐛 138 | 🌐 TypeScript | 📅 2026-08-26 - An unofficial, community-led Vue port of [shadcn/ui](https://github.com/shadcn-ui/ui) ⭐ 122,690 | 🐛 2,069 | 🌐 TypeScript | 📅 2026-08-31 (re-usable components built with Reka UI and Tailwind CSS).
* [buefy](https://github.com/rafaelpimpa/buefy) ⭐ 9,521 | 🐛 67 | 🌐 Vue | 📅 2026-08-31 - Components based on Bulma framework.
* [Nuxt UI](https://github.com/nuxt/ui) ⭐ 6,865 | 🐛 256 | 🌐 TypeScript | 📅 2026-09-01 - 125+ accessible and customizable components for Vue and Nuxt, built with Tailwind CSS and Reka UI.
* [Reka UI](https://github.com/unovue/reka-ui) ⭐ 6,759 | 🐛 314 | 🌐 Vue | 📅 2026-09-01 - An open-source library of unstyled, accessible UI primitives for building high-quality design systems and web apps in Vue 3 (formerly Radix Vue).
...
* [Inkline](https://github.com/inkline/inkline/) ⭐ 1,462 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-01 - Inkline is the intuitive UI Components library that gives you a developer-friendly foundation for building Vue.js 3 Design Systems.
* [oruga](https://github.com/oruga-ui/oruga) ⭐ 1,165 | 🐛 20 | 🌐 Vue | 📅 2026-08-31 - UI components for Vue.js without CSS framework dependency.
...
* [CoreUI for Vue.js](https://github.com/coreui/coreui-vue) ⭐ 642 | 🐛 4 | 🌐 MDX | 📅 2026-09-01 - CoreUI for Vue.js is a UI Component Library that offers a bunch of cross-browser, responsive, and lightweight Vue.js UI components.
...
* [Ionic](https://github.com/ionic-team/ionic-framework) ⭐ 52,638 | 🐛 594 | 🌐 TypeScript | 📅 2026-09-01 - Mobile app development framework
* [uni-app](https://github.com/dcloudio/uni-app) ⭐ 41,605 | 🐛 703 | 🌐 JavaScript | 📅 2026-09-01 - A cross-platform framework using Vue.js
...
* [Native script](https://github.com/nativescript-vue/nativescript-vue) ⭐ 6,462 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-26 - Native mobile applications using NativeScript
...
* [uiv](https://github.com/uiv-lib/uiv) ⭐ 937 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-01 - Bootstrap3 components implemented by Vue2.
...
* [vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) ⭐ 33,331 | 🐛 55 | 🌐 Vue | 📅 2026-09-01 - A modern vue admin. It is based on Vue3, vite and TypeScript. It's fast！ [Live demo](https://vben.vvbin.cn/)
* [gin-vue-admin](https://github.com/flipped-aurora/gin-vue-admin) ⭐ 24,985 | 🐛 43 | 🌐 Go | 📅 2026-08-29 - 🚀Vite+Vue3+Gin development basic platform. [Live demo](https://demo.gin-vue-admin.com)
* [soybean-admin](https://github.com/soybeanjs/soybean-admin/blob/main/README.en_US.md) ⭐ 14,925 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-13 - A clean, elegant, beautiful and powerful admin template, based on Vue3, Vite5, TypeScript, Pinia, NaiveUI and UnoCSS.
...
* [Admin One Vue 3 Tailwind dashboard](https://github.com/justboil/admin-one-vue-tailwind) ⭐ 2,466 | 🐛 34 | 🌐 Vue | 📅 2025-11-27 - Vue.js 3 Tailwind CSS admin template with dark mode.
...
* [Nuxt.js](https://github.com/nuxt/nuxt.js) ⭐ 60,808 | 🐛 543 | 🌐 TypeScript | 📅 2026-09-01 - Versatile Vue.js Framework.
...
* [VitePress](https://github.com/vuejs/vitepress) ⭐ 18,265 | 🐛 303 | 🌐 TypeScript | 📅 2026-08-30 - Vite & Vue powered static site generator.
...
* [vue-virtual-scroller](https://github.com/Akryum/vue-virtual-scroller) ⭐ 10,790 | 🐛 201 | 🌐 TypeScript | 📅 2026-08-12 - Component to scroll a large amount of elements efficiently (Vue 2.x).
...
* [tanstack-table](https://github.com/tanstack/table) ⭐ 28,395 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-31 - Headless UI for building powerful tables & datagrids.
* [ag-grid-vue](https://github.com/ag-grid/ag-grid) ⭐ 15,573 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-01 - Vue adaptor for ag-Grid.
* [vxe-table](https://github.com/x-extends/vxe-table) ⭐ 8,622 | 🐛 1,345 | 🌐 TypeScript | 📅 2026-09-01 - Vue form/table solution.
...
* [Toastflow](https://github.com/adrianjanocko/toastflow) ⭐ 196 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 - 💡 Headless toast (notification) engine + Vue 3 renderer (TS-first, CSS-first theming, highly customizable).
...
* [swiper](https://github.com/nolimits4web/swiper) ⭐ 41,900 | 🐛 236 | 🌐 TypeScript | 📅 2026-08-28 - Official Swiper component for Vue 3. Tree shakable, SSR support, typing, a11y and a lot more
* [@egjs/vue-flicking](https://github.com/naver/egjs-flicking/blob/master/packages/vue3-flicking/README.md) ⭐ 2,921 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-01 - It's reliable, flexible and extendable carousel for Vue.js 2 & 3.
...
* [vue-echarts](https://github.com/ecomfe/vue-echarts) ⭐ 10,741 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-31 - Vue.js component for Apache ECharts™.
* [vue-chartjs](https://github.com/apertureless/vue-chartjs) ⭐ 5,712 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-28 - Vue.js wrapper for Chart.js.
* [vue-data-ui](https://github.com/graphieros/vue-data-ui) ⭐ 2,445 | 🐛 0 | 🌐 Vue | 📅 2026-08-30 - Vue 3 chart library with 60+ components. Official site: <https://vue-data-ui.graphieros.com/>
...
* [schedule-x](https://github.com/schedule-x/schedule-x) ⭐ 2,546 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-31 - A material design event calendar. Customizable, light- and dark modes & multilingual.
...
* [vue-cesium](https://github.com/zouyaoji/vue-cesium) ⭐ 1,911 | 🐛 19 | 🌐 HTML | 📅 2026-07-30 - Vue 2.x & Vue 3.x components for Cesium.
...
* [virtua](https://github.com/inokawa/virtua) ⭐ 3,731 | 🐛 63 | 🌐 TypeScript | 📅 2026-08-31 - A zero-config, fast and small (\~3kB) virtual list component for React and Vue
...
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 2,979 | 🐛 2 | 🌐 Vue | 📅 2026-09-01 - Streaming Markdown renderer for Vue 3, Nuxt, and VitePress AI chat UIs, with support for incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [vue-flow](https://github.com/bcakmakoglu/vue-flow) ⭐ 6,818 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-14 - Interactive, customizeabe, graph & flowchart editor for Vue3
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,973 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-31 - A lightweight Javascript library to easily create highly configurable and interactive particle animations
...
* [vue-word-highlighter](https://github.com/kawamataryo/vue-word-highlighter) ⭐ 341 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-31 - The word highlighter library for Vue 2 and Vue 3.
...
* [vue-month-spinner-picker](https://github.com/jlc488/vue-month-spinner-picker) ⭐ 0 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-12 - iOS-style drum-roll month picker for Vue 3. Inertia scrolling, bottom sheet modal, min/max constraints, i18n and theming via CSS variables. Zero dependencies.
...
* [tiptap](https://github.com/heyscrumpy/tiptap) ⭐ 38,214 | 🐛 832 | 🌐 TypeScript | 📅 2026-09-01 - A renderless and extendable rich-text editor for Vue.js
* [ckeditor5-vue](https://github.com/ckeditor/ckeditor5-vue) ⭐ 387 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-01 - An official CKEditor 5 rich text editor component for Vue.js.
...
* [vue3-form-wizard](https://github.com/parsajiravand/vue3-form-wizard) ⭐ 39 | 🐛 6 | 🌐 Vue | 📅 2026-08-30 - Vue3-form-wizard is a vue based component with no external depenendcies which simplifies tab wizard management.

#### Canvas

* [vue-konva](https://github.com/rafaesc/vue-konva) ⭐ 1,355 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-31 - Vue & Canvas - JavaScript library for drawing complex canvas graphics using Vue.
...
* [vee-validate](https://github.com/logaretm/vee-validate) ⭐ 11,264 | 🐛 172 | 🌐 TypeScript | 📅 2026-03-04 - Simple Vue.js input validation plugin.
...
* [vest](https://github.com/ealush/vest) ⭐ 2,665 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-01 - 🦺 Declarative form validation framework inspired by unit testing.
...
* [validup](https://github.com/tada5hi/validup) ⭐ 5 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-31 - Composable, path-based validation with a Vue 3 composable (`@validup/vue`) for reactive forms, groups, and structured issues.
...
* [@formkit/auto-animate](https://github.com/formkit/auto-animate) ⭐ 13,912 | 🐛 42 | 🌐 TypeScript | 📅 2026-07-10 Add motion to your apps with a single line of code
...
* [Unhead](https://github.com/unjs/unhead) ⭐ 1,305 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-31
...
* [vueuse](https://github.com/vueuse/vueuse) ⭐ 22,339 | 🐛 375 | 🌐 TypeScript | 📅 2026-09-01 - Collection of essential Vue Composition API utils works for Vue 2.x and 3.x.
...
* [unplugin-auto-import](https://github.com/unplugin/unplugin-auto-import) ⭐ 3,793 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-03 - Auto import Vue APIs on-demand for Vite, Webpack and Rollup.
...
* [tanstack-query](https://github.com/tanstack/query) ⭐ 50,243 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-01 - Powerful asynchronous state management.
...
* [@stitchapi/vue](https://github.com/rejifald/StitchAPI/tree/main/packages/vue) ⭐ 17 | 🐛 86 | 🌐 TypeScript | 📅 2026-08-31 - Streaming-first StitchAPI bindings: typed, validated `useStitch` / `useStitchStream` composables that re-render as response deltas arrive.
...
* [intlify/vue-i18n-next](https://github.com/intlify/vue-i18n-next) ⭐ 2,711 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-01 - Vue I18n for Vue 3.
* [vue-intlayer](https://github.com/aymericzip/intlayer) ⭐ 817 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-01 - Intlayer i18n solution for vue 3.
...
* [fluent-vue](https://github.com/Demivan/fluent-vue) ⭐ 278 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-01 - Internationalization plugin for Vue.js (2 and 3). Vue.js integration for Fluent.js - JavaScript implementation of Project Fluent
...
* [pinia-persistedstate-2](https://github.com/iendeavor/pinia-plugin-persistedstate-2) ⭐ 116 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-01 - Persist and rehydrate your Pinia state between page reloads.
...
* [vue-apollo](https://github.com/Akryum/vue-apollo) ⭐ 6,033 | 🐛 276 | 🌐 TypeScript | 📅 2026-08-06 - Apollo/GraphQL integration for VueJS.

#### Code Style

*Improve readability of code*

* [eslint-plugin-vue](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,592 | 🐛 208 | 🌐 TypeScript | 📅 2026-08-30 - Eslint plugin for Vue.js projects.
* [vue-types](https://github.com/dwightjack/vue-types) ⭐ 583 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-01 - Vue Prop Types definitions.
* [vue-ts-types](https://github.com/FloEdelmann/vue-ts-types) ⭐ 13 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-01 - Lightweight TypeScript-first Vue prop type definitions.
...
* [vite-svg-loader](https://github.com/jpkleemans/vite-svg-loader) ⭐ 701 | 🐛 40 | 🌐 JavaScript | 📅 2026-09-01 - Vite plugin to load SVG files as Vue components
...
* [vue-recaptcha](https://github.com/DanSnow/vue-recaptcha) ⭐ 897 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-01 - Google reCAPTCHA component for Vue.js
...
* [@agentskit/vue](https://github.com/AgentsKit-io/agentskit) ⭐ 25 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-01 - Vue 3 composable and headless chat components for building AI agents, with streaming, tools, memory and RAG.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,469 | 🐛 87 | 🌐 TypeScript | 📅 2026-09-01 - Manage and reuse `vue` components between projects. Easily isolate and share components from any project without changing its source code, organize curated collections and install in different projects.
...
* [vitest](https://github.com/vitest-dev/vitest) ⭐ 17,030 | 🐛 375 | 🌐 TypeScript | 📅 2026-08-31 - Next generation testing framework powered by Vite.
...
* [jest-serializer-vue-tjw](https://github.com/tjw-lint/vue3-snapshot-serializer) ⭐ 16 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-31 - Improved formatting of Jest Snapshots
...
* [Vue Language Tools (Volar)](https://github.com/vuejs/language-tools) ⭐ 6,716 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-01 - ⚡The Fastest Vue Language Support Extension
...
* [Vue.js support for WebStorm](https://github.com/JetBrains/intellij-plugins/tree/master/vuejs) ⭐ 2,268 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-01, IntelliJ IDEA, PhpStorm, PyCharm & RubyMine – official Vue.js support by JetBrains
...
* [Vite](https://github.com/vitejs/vite) ⭐ 82,631 | 🐛 766 | 🌐 TypeScript | 📅 2026-09-01 - Next generation frontend tooling. It's fast!
...
* [Create Vue](https://github.com/vuejs/create-vue) ⭐ 4,395 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-01
...
* [ILUMINATY](https://github.com/LuynoxRD/ILUMINATY) ⭐ 3 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-01 - Vue 3 + Vite SSG template for editorial sites, directories, events and blogs with Sanity CMS integration.
...
* [electron-vite-vue](https://github.com/electron-vite/electron-vite-vue) ⭐ 4,890 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-01 - Really simple Electron + Vite + Vue boilerplate.
