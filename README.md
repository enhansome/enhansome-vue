...
## Awesome Vue.js [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@main/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 497,066 | 🐛 103 | 📅 2026-06-30 [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/vuejs/awesome-vue)
...
* [Release Notes](https://github.com/vuejs/core/releases) ⭐ 54,212 | 🐛 907 | 🌐 TypeScript | 📅 2026-08-18
* [Awesome Vite](https://github.com/vitejs/awesome-vite) ⭐ 17,220 | 🐛 131 | 🌐 JavaScript | 📅 2026-02-04
* [IDE Language Support](https://github.com/vuejs/language-tools?tab=readme-ov-file#vue-language-tools) ⭐ 6,710 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-17
...
* [unplugin-icons](https://github.com/unplugin/unplugin-icons) ⭐ 4,928 | 🐛 86 | 🌐 TypeScript | 📅 2026-01-14 - On-demand icon loader supporting all known popular icon sets
...
* [vue-i18n](https://github.com/intlify/vue-i18n) ⭐ 2,705 | 🐛 91 | 🌐 TypeScript | 📅 2026-08-17 - Internationalization plugin for Vue.js
...
* [Vue.js TodoMVC](https://github.com/vuejs/vue/tree/dev/examples/todomvc) ⭐ 210,224 | 🐛 637 | 🌐 TypeScript | 📅 2024-10-10

### Tutorials

* [Help you learn more efficiently vue3 source code - mini-vue](https://github.com/cuixiaorui/mini-vue) ⭐ 10,550 | 🐛 27 | 🌐 TypeScript | 📅 2024-03-25 by cuixiaorui
...
* [umo editor](https://github.com/umodoc/editor) ⭐ 1,571 | 🐛 1 | 🌐 Vue | 📅 2026-08-18 - Umo Editor is an open-source document editor, based on Vue3 and Tiptap. Visit [Playground](https://demo.umodoc.com/editor?lang=en-US) for a fast experience.
...
* [slidev](https://github.com/slidevjs/slidev) ⭐ 48,127 | 🐛 208 | 🌐 TypeScript | 📅 2026-08-14 - Presentation Slides for Developers

* [YesPlayMusic](https://github.com/qier222/YesPlayMusic) ⭐ 33,161 | 🐛 652 | 🌐 Vue | 📅 2026-06-14 - High-looking third-party NetEase cloud player, support Windows / macOS / Linux :electron:

* [Wiki.js](https://github.com/Requarks/wiki) ⭐ 28,771 | 🐛 189 | 🌐 Vue | 📅 2026-08-18 - A modern, lightweight and powerful wiki app built on NodeJS, Git and Markdown

* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 27,978 | 🐛 40 | 🌐 PHP | 📅 2026-08-17 - A Free and Opensource Laravel eCommerce framework built for all to build and scale your business.

* [Dashy](https://github.com/lissy93/dashy) ⭐ 26,222 | 🐛 32 | 🌐 Vue | 📅 2026-08-16 - A self-hosted startpage, with an easy to use visual editor, status checking, themes, widgets and tons more

* [Stack Edit](https://github.com/benweet/stackedit/) ⭐ 23,063 | 🐛 732 | 🌐 JavaScript | 📅 2023-07-04 - In-browser Markdown editor

* [Daily](https://github.com/dailynowco/daily) ⭐ 20,023 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-12 - Curated dev news delivered to your new tab 👩🏽‍💻

* [Koel](https://github.com/phanan/koel) ⭐ 17,222 | 🐛 14 | 🌐 PHP | 📅 2026-08-10 - A personal music streaming server that works.

* [MyIP](https://github.com/jason5ng32/MyIP) ⭐ 11,630 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-17 - All in one IP Toolbox. Easy to check what's your IPs, IP geolocation, check for DNS leaks, examine WebRTC connections, speed test, ping test, MTR test, check website availability and more.

* [douyin](https://github.com/zyronon/douyin) ⭐ 11,527 | 🐛 24 | 🌐 Vue | 📅 2026-07-21 - Imitate TikTok ，Vue Best practices on Mobile
...
* [Akaunting](https://github.com/akaunting/akaunting) ⭐ 10,064 | 🐛 10 | 🌐 PHP | 📅 2026-08-18 - A free and online accounting software for small businesses and freelancers based on Laravel and VueJS.

* [nativescript-vue](https://github.com/rigor789/nativescript-vue) ⭐ 6,462 | 🐛 37 | 🌐 TypeScript | 📅 2025-10-17 - A Vue.js implementation of the NativeScript renderer.

* [Aimeos](https://github.com/aimeos/aimeos) ⭐ 5,449 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-29 - Leading Laravel eCommerce framework to build ultra fast online shops, marketplaces and complex B2B applications scalable from 1 to 1,000,000,000+ items

* [MQTTX](https://github.com/emqx/MQTTX) ⭐ 5,025 | 🐛 109 | 🌐 TypeScript | 📅 2026-08-17 - Cross-platform MQTT 5.0 desktop client built with Vue.js, Typescript and Electron.
...
* [PJ Blog](https://github.com/jcc/blog) ⭐ 2,855 | 🐛 38 | 🌐 PHP | 📅 2023-06-08 - Open source blog built with Laravel and Vue.js.
...
* [GrandNode 2.0](https://github.com/grandnode/grandnode2/) ⭐ 1,323 | 🐛 86 | 🌐 C# | 📅 2026-08-17 - Open Source Cross Platform E-Commerce Solution based on .NET Core 5.0 and MongoDB / Azure CosmosDB / Amazon DocumentDB / VueJS
...
* [LogChimp](https://github.com/logchimp/logchimp) ⭐ 1,117 | 🐛 186 | 🌐 TypeScript | 📅 2026-08-17 - Open-source software to track your customer's feedback to build better products.
...
* [MarkerOn](https://github.com/ifer47/markeron) ⭐ 903 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-18 - Lightweight screen annotation tool built with Tauri v2, Vue 3, and Canvas API for drawing, highlighting, and annotating anywhere on desktop.

* [QMK Configurator](https://github.com/qmk/qmk_configurator) ⭐ 839 | 🐛 101 | 🌐 JavaScript | 📅 2026-01-28 - QMK Firmware Keyboard Configuration UI in Vue.js.
...
* [VueFinder File Library](https://github.com/n1crack/vuefinder) ⭐ 597 | 🐛 5 | 🌐 Vue | 📅 2026-08-18 - Web File Manager Library.
...
* [Socialhome](https://github.com/jaywink/socialhome) ⭐ 386 | 🐛 127 | 🌐 Python | 📅 2026-08-16 - A federated rich profile builder with social networking features
...
* [Carpoolear](https://github.com/STS-Rosario/carpoolear) ⭐ 100 | 🐛 38 | 🌐 JavaScript | 📅 2026-08-17 - The open source Vue.js frontend (mobile and cordova app) for the argentinian carpooling application: [Carpoolear](https://carpoolear.com.ar)
...
* [CodeceptJS UI](https://github.com/codecept-js/ui) ⭐ 84 | 🐛 22 | 🌐 JavaScript | 📅 2026-08-18 - Cypress-liked UI for ✔️ CodeceptJS end 2 end tests ✔️.
...
* [NocoDB](https://github.com/nocodb/nocodb) ⭐ 64,570 | 🐛 704 | 🌐 TypeScript | 📅 2026-08-18 - An opensource Airtable alternative.
...
* [vuetify](https://github.com/vuetifyjs/vuetify) ⭐ 41,031 | 🐛 396 | 🌐 TypeScript | 📅 2026-08-18 - Material Component Framework for Vue.js 2.
* [Element Plus](https://github.com/element-plus/element-plus) ⭐ 27,676 | 🐛 1,203 | 🌐 TypeScript | 📅 2026-08-17 - A Vue 3 UI Framework.
* [quasar-framework](https://github.com/quasarframework/quasar) ⭐ 27,203 | 🐛 518 | 🌐 JavaScript | 📅 2026-08-17 - Quasar Framework. Build responsive websites, hybrid mobile Apps and Electron apps using same code, with Vue.js 3.
...
* [Naive UI](https://github.com/TuSimple/naive-ui) ⭐ 18,493 | 🐛 687 | 🌐 TypeScript | 📅 2026-08-16 - A Vue 3 Component Library Fairly Complete, Customizable Themes, Uses TypeScript, Not Too Slow Kinda Interesting
* [BootstrapVue](https://github.com/bootstrap-vue/bootstrap-vue) ⭐ 14,426 | 🐛 202 | 🌐 JavaScript | 📅 2026-04-02 - Bootstrap v4 components and grid system for Vue.js.
* [shadcn-vue](https://github.com/unovue/shadcn-vue) ⭐ 10,462 | 🐛 136 | 🌐 TypeScript | 📅 2026-08-17 - An unofficial, community-led Vue port of [shadcn/ui](https://github.com/shadcn-ui/ui) ⭐ 121,524 | 🐛 2,299 | 🌐 TypeScript | 📅 2026-08-17 (re-usable components built with Reka UI and Tailwind CSS).
* [buefy](https://github.com/rafaelpimpa/buefy) ⭐ 9,520 | 🐛 71 | 🌐 Vue | 📅 2026-08-17 - Components based on Bulma framework.
* [Nuxt UI](https://github.com/nuxt/ui) ⭐ 6,838 | 🐛 250 | 🌐 TypeScript | 📅 2026-08-17 - 125+ accessible and customizable components for Vue and Nuxt, built with Tailwind CSS and Reka UI.
* [Reka UI](https://github.com/unovue/reka-ui) ⭐ 6,726 | 🐛 307 | 🌐 Vue | 📅 2026-08-18 - An open-source library of unstyled, accessible UI primitives for building high-quality design systems and web apps in Vue 3 (formerly Radix Vue).
...
* [oruga](https://github.com/oruga-ui/oruga) ⭐ 1,166 | 🐛 19 | 🌐 Vue | 📅 2026-08-17 - UI components for Vue.js without CSS framework dependency.
...
* [Ionic](https://github.com/ionic-team/ionic-framework) ⭐ 52,620 | 🐛 616 | 🌐 TypeScript | 📅 2026-08-17 - Mobile app development framework
* [uni-app](https://github.com/dcloudio/uni-app) ⭐ 41,597 | 🐛 698 | 🌐 JavaScript | 📅 2026-08-18 - A cross-platform framework using Vue.js
* [Framework7-Vue](https://github.com/framework7io/framework7) ⭐ 18,742 | 🐛 246 | 🌐 JavaScript | 📅 2026-07-28 - Build full-featured iOS & Android apps using Framework7 & Vue.
* [vue-onsenui](https://github.com/OnsenUI/OnsenUI) ⭐ 8,859 | 🐛 14 | 🌐 JavaScript | 📅 2026-06-17 - Mobile app development framework and SDK using HTML5 and JavaScript. Create beautiful and performant cross-platform mobile apps. Based on Web Components, and provides bindings for Angular 1, 2, React and Vue.js.
* [Native script](https://github.com/nativescript-vue/nativescript-vue) ⭐ 6,462 | 🐛 37 | 🌐 TypeScript | 📅 2025-10-17 - Native mobile applications using NativeScript

*Set of components for mobile*

* [vant](https://github.com/youzan/vant) ⭐ 24,363 | 🐛 218 | 🌐 TypeScript | 📅 2026-08-18 - A Vue.js 2.0 Mobile UI From YouZan.
...
* [uiv](https://github.com/uiv-lib/uiv) ⭐ 938 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-17 - Bootstrap3 components implemented by Vue2.
...
* [vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) ⭐ 33,155 | 🐛 76 | 🌐 Vue | 📅 2026-08-17 - A modern vue admin. It is based on Vue3, vite and TypeScript. It's fast！ [Live demo](https://vben.vvbin.cn/)
* [gin-vue-admin](https://github.com/flipped-aurora/gin-vue-admin) ⭐ 24,948 | 🐛 40 | 🌐 Go | 📅 2026-08-15 - 🚀Vite+Vue3+Gin development basic platform. [Live demo](https://demo.gin-vue-admin.com)
* [soybean-admin](https://github.com/soybeanjs/soybean-admin/blob/main/README.en_US.md) ⭐ 14,827 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-13 - A clean, elegant, beautiful and powerful admin template, based on Vue3, Vite5, TypeScript, Pinia, NaiveUI and UnoCSS.
...
* [Nuxt.js](https://github.com/nuxt/nuxt.js) ⭐ 60,763 | 🐛 542 | 🌐 TypeScript | 📅 2026-08-18 - Versatile Vue.js Framework.
...
* [VitePress](https://github.com/vuejs/vitepress) ⭐ 18,195 | 🐛 331 | 🌐 TypeScript | 📅 2026-08-18 - Vite & Vue powered static site generator.
* [îles](https://github.com/ElMassimo/iles) ⭐ 1,161 | 🐛 41 | 🌐 TypeScript | 📅 2026-04-10 - Islands of interactivity, the joyful site generator

#### Other

* [Fes.js](https://github.com/WeBankFinTech/fes.js/blob/master/README.en-US.md) ⭐ 1,654 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-11 - An easy-to-use front-end application framework based on vue3.
* [CabloyJS](https://github.com/zhennann/cabloy) ⭐ 970 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-17 The Ultimate NodeJS Full Stack Business Development Platform, based on KoaJS & EggJS & VueJS & Framework7
...
* [DataFormsJS](https://github.com/dataformsjs/dataformsjs) ⭐ 196 | 🐛 0 | 🌐 JavaScript | 📅 2025-07-31 - A minimal routing and web service framework that uses Vue as a templating engine.
...
* [vue-stack-grid](https://github.com/chiribuc/vue-stack-grid) ⭐ 14 | 🐛 2 | 🌐 Vue | 📅 2026-08-17 - A Vue 3 component designed to make creating dynamic, responsive grid layouts easy and efficient.
...
* [tanstack-table](https://github.com/tanstack/table) ⭐ 28,341 | 🐛 59 | 🌐 TypeScript | 📅 2026-08-16 - Headless UI for building powerful tables & datagrids.
* [ag-grid-vue](https://github.com/ag-grid/ag-grid) ⭐ 15,543 | 🐛 149 | 🌐 TypeScript | 📅 2026-08-17 - Vue adaptor for ag-Grid.
* [vxe-table](https://github.com/x-extends/vxe-table) ⭐ 8,613 | 🐛 1,343 | 🌐 TypeScript | 📅 2026-08-18 - Vue form/table solution.
* [vue-cheetah-grid](https://github.com/future-architect/cheetah-grid) ⭐ 1,530 | 🐛 36 | 🌐 JavaScript | 📅 2026-05-17 - A high-performance grid engine that work on a canvas for Vue.js.
...
* [vue-datagrid](https://github.com/revolist/vue-datagrid) ⭐ 211 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-17 - Vue grid wrapper for powerful webcomponent revo-grid with excel like rich edit and behavior.
* [GridSheet](https://github.com/walkframe/gridsheet) ⭐ 194 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-17 - Highly customizable spreadsheet engine with formula support, multi-sheet references, and a Vue3 wrapper built on a Preact core.
...
* [Toastflow](https://github.com/adrianjanocko/toastflow) ⭐ 196 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-12 - 💡 Headless toast (notification) engine + Vue 3 renderer (TS-first, CSS-first theming, highly customizable).
...
* [phantom-ui](https://github.com/Aejkatappaja/phantom-ui) ⭐ 784 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31 - Structure-aware skeleton loader web component that measures your real DOM, supports Vue, React, Svelte and plain HTML.
...
* [vue-echarts](https://github.com/ecomfe/vue-echarts) ⭐ 10,733 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-17 - Vue.js component for Apache ECharts™.
* [vue-chartjs](https://github.com/apertureless/vue-chartjs) ⭐ 5,714 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-14 - Vue.js wrapper for Chart.js.
* [vue-data-ui](https://github.com/graphieros/vue-data-ui) ⭐ 2,439 | 🐛 0 | 🌐 Vue | 📅 2026-08-18 - Vue 3 chart library with 60+ components. Official site: <https://vue-data-ui.graphieros.com/>
* [vue-apexcharts](https://github.com/apexcharts/vue-apexcharts) ⭐ 1,344 | 🐛 9 | 🌐 Vue | 📅 2026-08-11 - Vue.js component for [ApexCharts](https://github.com/apexcharts/apexcharts.js) ⭐ 15,127 | 🐛 329 | 🌐 JavaScript | 📅 2026-08-18.
...
* [schedule-x](https://github.com/schedule-x/schedule-x) ⭐ 2,531 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - A material design event calendar. Customizable, light- and dark modes & multilingual.
...
* [@maxel01/vue-leaflet](https://github.com/maxel01/vue-leaflet) ⭐ 52 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-17 - Vue 3 components for Leaflet (2.x) maps.
...
* [virtua](https://github.com/inokawa/virtua) ⭐ 3,716 | 🐛 69 | 🌐 TypeScript | 📅 2026-08-18 - A zero-config, fast and small (\~3kB) virtual list component for React and Vue
* [@egjs/vue-infinitegrid](https://github.com/naver/egjs-infinitegrid/blob/master/packages/vue-infinitegrid/) ⭐ 2,361 | 🐛 3 | 🌐 TypeScript | 📅 2026-04-14 - Arrange infinite card elements according to various layout types like masonry for Vue.js 2.
...
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 2,896 | 🐛 1 | 🌐 Vue | 📅 2026-08-18 - Streaming Markdown renderer for Vue 3, Nuxt, and VitePress AI chat UIs, with support for incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [vue-flow](https://github.com/bcakmakoglu/vue-flow) ⭐ 6,786 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-14 - Interactive, customizeabe, graph & flowchart editor for Vue3
...
* [qrcode.vue](https://github.com/scopewu/qrcode.vue) ⭐ 826 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-18 - A Vue.js component to generate qrcode. Supports both Vue 2 and Vue 3.
...
* [vue-word-highlighter](https://github.com/kawamataryo/vue-word-highlighter) ⭐ 341 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-18 - The word highlighter library for Vue 2 and Vue 3.
...
* [vue-multiselect](https://github.com/monterail/vue-multiselect) ⭐ 6,780 | 🐛 306 | 🌐 JavaScript | 📅 2026-03-17 - Universal select/multiselect/tagging component for Vue.js.
* [vue-select](https://github.com/sagalbot/vue-select) ⭐ 4,670 | 🐛 336 | 🌐 JavaScript | 📅 2026-02-17 - A native Vue.js component that provides similar functionality to Select2 without the overhead of jQuery.
...
* [Vue DnD Kit](https://github.com/zizigy/vue-dnd-kit) ⭐ 250 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-14 - A lightweight, performant drag and drop toolkit for Vue 3 with composable API, keyboard navigation, accessibility support, and advanced customization options. Supports any cases, and touch devices. Inspired by React DnD Kit
...
* [vue-currency-input](https://github.com/dm4t2/vue-currency-input) ⭐ 693 | 🐛 8 | 🌐 TypeScript | 📅 2026-05-25 - Easy input of currency formatted numbers for Vue.js.
...
* [tiptap](https://github.com/heyscrumpy/tiptap) ⭐ 38,052 | 🐛 851 | 🌐 TypeScript | 📅 2026-08-17 - A renderless and extendable rich-text editor for Vue.js
...
* [vest](https://github.com/ealush/vest) ⭐ 2,664 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-18 - 🦺 Declarative form validation framework inspired by unit testing.
...
* [NotForm](https://github.com/favorodera/notform) ⭐ 20 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-17 - Headless, composable form validation for Vue.js. Bring your own UI and schema (Zod, Valibot, ArkType, or any Standard-Schema compliant validator).
...
* [validup](https://github.com/tada5hi/validup) ⭐ 4 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-17 - Composable, path-based validation with a Vue 3 composable (`@validup/vue`) for reactive forms, groups, and structured issues.
...
* [vue-router](https://github.com/vuejs/vue-router) ⭐ 18,875 | 🐛 125 | 🌐 JavaScript | 📅 2026-04-14 - The official router for Vue.js.
...
* [kitbag/router](https://github.com/kitbagjs/router) ⭐ 253 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-17 - A type safe router for vuejs
...
* [ssgoi](https://github.com/meursyphus/ssgoi) ⭐ 956 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-17 - Native app-like page transitions with spring physics, 60fps on mobile, SSR-ready, and all modern browser support
...
* [Unhead](https://github.com/unjs/unhead) ⭐ 1,300 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-17
...
* [TresJs](https://github.com/tresjs/tres) ⭐ 3,659 | 🐛 97 | 🌐 Vue | 📅 2026-08-17 - Declarative ThreeJS using Vue Components
...
* [vueuse](https://github.com/vueuse/vueuse) ⭐ 22,320 | 🐛 365 | 🌐 TypeScript | 📅 2026-08-13 - Collection of essential Vue Composition API utils works for Vue 2.x and 3.x.
...
* [unplugin-auto-import](https://github.com/unplugin/unplugin-auto-import) ⭐ 3,790 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-03 - Auto import Vue APIs on-demand for Vite, Webpack and Rollup.
...
* [tanstack-query](https://github.com/tanstack/query) ⭐ 50,149 | 🐛 210 | 🌐 TypeScript | 📅 2026-08-17 - Powerful asynchronous state management.
...
* [@stitchapi/vue](https://github.com/rejifald/StitchAPI/tree/main/packages/vue) ⭐ 17 | 🐛 85 | 🌐 TypeScript | 📅 2026-08-17 - Streaming-first StitchAPI bindings: typed, validated `useStitch` / `useStitchStream` composables that re-render as response deltas arrive.
...
* [intlify/vue-i18n-next](https://github.com/intlify/vue-i18n-next) ⭐ 2,705 | 🐛 91 | 🌐 TypeScript | 📅 2026-08-17 - Vue I18n for Vue 3.
* [vue-intlayer](https://github.com/aymericzip/intlayer) ⭐ 795 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-18 - Intlayer i18n solution for vue 3.
...
* [tolgee/vue](https://github.com/tolgee/tolgee-js/tree/main/packages/vue) ⭐ 260 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-17 - Web-based localization tool enabling users to translate directly in the Vue 3 app they develop.
...
* [pinia](https://github.com/posva/pinia) ⭐ 14,698 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-12 - 🍍 Intuitive, type safe, light and flexible Store for Vue using the composition api with DevTools support.
...
* [eslint-plugin-vue](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,592 | 🐛 205 | 🌐 TypeScript | 📅 2026-08-15 - Eslint plugin for Vue.js projects.
* [vue-types](https://github.com/dwightjack/vue-types) ⭐ 583 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-17 - Vue Prop Types definitions.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,456 | 🐛 101 | 🌐 TypeScript | 📅 2026-08-18 - Manage and reuse `vue` components between projects. Easily isolate and share components from any project without changing its source code, organize curated collections and install in different projects.
...
* [vitest](https://github.com/vitest-dev/vitest) ⭐ 16,966 | 🐛 368 | 🌐 TypeScript | 📅 2026-08-17 - Next generation testing framework powered by Vite.
...
* [jest-serializer-vue-tjw](https://github.com/tjw-lint/vue3-snapshot-serializer) ⭐ 16 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-17 - Improved formatting of Jest Snapshots
...
* [Vue Language Tools (Volar)](https://github.com/vuejs/language-tools) ⭐ 6,710 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-17 - ⚡The Fastest Vue Language Support Extension
...
* [Vue.js support for WebStorm](https://github.com/JetBrains/intellij-plugins/tree/master/vuejs) ⭐ 2,265 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-18, IntelliJ IDEA, PhpStorm, PyCharm & RubyMine – official Vue.js support by JetBrains
...
* [Vite](https://github.com/vitejs/vite) ⭐ 82,382 | 🐛 791 | 🌐 TypeScript | 📅 2026-08-18 - Next generation frontend tooling. It's fast!
...
* [Create Vue](https://github.com/vuejs/create-vue) ⭐ 4,389 | 🐛 37 | 🌐 Vue | 📅 2026-08-17
...
* [Mevn-CLI](https://github.com/madlabsinc/mevn-cli) ⭐ 830 | 🐛 15 | 🌐 JavaScript | 📅 2026-07-23 - Light speed setup for MEVN stack based apps.
...
* [vue-genesis](https://github.com/fmfe/genesis) ⭐ 677 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-13 - 🔥Micro front end, micro service and lightweight solution based on Vue SSR🔥
